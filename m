...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id C3026433D5F
	for <lists+linux-kselftest@lfdr.de>; Tue, 19 Oct 2021 19:24:52 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S234594AbhJSR1E (ORCPT <rfc822;lists+linux-kselftest@lfdr.de>);
        Tue, 19 Oct 2021 13:27:04 -0400
Received: from mail.kernel.org ([198.145.29.99]:55106 "EHLO mail.kernel.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S234650AbhJSR1D (ORCPT <rfc822;linux-kselftest@vger.kernel.org>);
        Tue, 19 Oct 2021 13:27:03 -0400
Received: by mail.kernel.org (Postfix) with ESMTPSA id 3A87361212;
        Tue, 19 Oct 2021 17:24:50 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
        s=k20201202; t=1634664290;
        bh=BskVFmj52MV/sawgNPoGyKGDfx6Emx1P5mNw+ruzxMM=;
        h=From:To:Cc:Subject:Date:In-Reply-To:References:From;
        b=
...
Subject: [PATCH v3 27/42] arm64/sme: Implement traps and syscall handling for SME
Date:   Tue, 19 Oct 2021 18:22:32 +0100
Message-Id: <20211019172247.3045838-28-broonie@kernel.org>
X-Mailer: git-send-email 2.30.2
In-Reply-To: <20211019172247.3045838-1-broonie@kernel.org>
References: <20211019172247.3045838-1-broonie@kernel.org>
MIME-Version: 1.0
X-Developer-Signature: v=1; a=openpgp-sha256; l=16161; h=from:subject; bh=BskVFmj52MV/sawgNPoGyKGDfx6Emx1P5mNw+ruzxMM=; b=owEBbQGS/pANAwAKASTWi3JdVIfQAcsmYgBhbv7Y0lk9duFeDfEFLmqshBRwhEFDlKRABAEpphhy PQDKHgqJATMEAAEKAB0WIQSt5miqZ1cYtZ/in+ok1otyXVSH0AUCYW7+2AAKCRAk1otyXVSH0F5yB/ 4kIrgq8ivGgju6H91je1VT1GP/0puKxOUx29sahvD9oNd/ThAddrCubiictLVEBNbmK+GDdI37oJOU jEbb0ef6L8HxeKqSeM+L5z8db/aY3PACUqEl9ojW/L6ksxzPBwaNq3oCkxeLivu7qxK7gjngInhHQ0 ZB+NtrfbUsF69zXd9S3/CVEhforYvq+48D931d3F9D78tQpMX4EP39K+PpPgE6ZGzqCXGSKRBVvgBT Z1q5WZDaD78X7stSVMJaTzNWTrOhA1EBLr4fmT1CaQhTtU1Rq7Wjw9MD+OUIyNlscZeRVGpGZahs0f DdeGYaHQkoO5MEqUcAY2llmoTTHQIs
...
index 426f6be0f466..8965c012623e 100644
...
@@ -807,18 +813,22 @@ int vec_set_vector_length(struct task_struct *task, enum vec_type type,
...
@@ -1163,12 +1173,55 @@ void __init sve_setup(void)
...
@@ -1267,6 +1320,29 @@ void __init sme_setup(void)
...
+
  ...
  * Trapped SVE access
  *
@@ -1298,22 +1374,77 @@ void do_sve_acc(unsigned int esr, struct pt_regs *regs)
...
@@ -1430,8 +1561,11 @@ void fpsimd_flush_thread(void)
...
@@ -1480,14 +1614,22 @@ static void fpsimd_bind_task_to_cpu(void)
