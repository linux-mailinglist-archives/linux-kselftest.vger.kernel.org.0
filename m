...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id D444647E598
	for <lists+linux-kselftest@lfdr.de>; Thu, 23 Dec 2021 16:41:08 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1349109AbhLWPlA (ORCPT <rfc822;lists+linux-kselftest@lfdr.de>);
        Thu, 23 Dec 2021 10:41:00 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:33840 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1349053AbhLWPku (ORCPT
        <rfc822;linux-kselftest@vger.kernel.org>);
        Thu, 23 Dec 2021 10:40:50 -0500
Received: from mail-ed1-x529.google.com (mail-ed1-x529.google.com [IPv6:2a00:1450:4864:20::529])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 78923C06175D;
        Thu, 23 Dec 2021 07:40:49 -0800 (PST)
Received: by mail-ed1-x529.google.com with SMTP id b13so22890309edd.8;
        Thu, 23 Dec 2021 07:40:49 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=20210112;
        h=from:to:cc:subject:date:message-id:in-reply-to:references
         :mime-version:content-transfer-encoding;
        bh=/x/PpeZKrQrS0slQwQGqxQBtuxghwfMqUx1IqVwqbsA=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=/x/PpeZKrQrS0slQwQGqxQBtuxghwfMqUx1IqVwqbsA=;
        b=
X-Gm-Message-State: AOAM531qaUY+e+Tdq/oCb3hMy4PGa82bIQcpbtJOp+N/6zoRiWZAFQh0
        WN6QBlngSiA/iXb84tz2Jzk=
X-Google-Smtp-Source: ABdhPJxZ4snSAEnyl6UmdWqcXHRqKDPdXy8gllr6Ovdqi9YivSkRdCGWEx32C+OFD65TMLRqTjKsuQ==
X-Received: by 2002:a17:906:9753:: with SMTP id o19mr2339041ejy.243.1640274047573;
        Thu, 23 Dec 2021 07:40:47 -0800 (PST)
Received: from ponky.lan ([2a04:241e:501:3870:7c02:dfc6:b554:ab10])
        by smtp.gmail.com with ESMTPSA id bx6sm2088617edb.78.2021.12.23.07.40.45
...
Subject: [PATCH v4 06/19] tcp: authopt: Hook into tcp core
Date:   Thu, 23 Dec 2021 17:40:01 +0200
Message-Id: <efa9feec4ff3037ead64c16d981054245002ba70.1640273966.git.cdleonard@gmail.com>
...
index 01bc12ad56f1..ba20a70359ee 100644
...
@@ -261,10 +265,55 @@ static bool tcp_authopt_key_match_exact(struct tcp_authopt_key_info *info,
 			return false;
...
@@ -274,10 +323,52 @@ static struct tcp_authopt_key_info *tcp_authopt_key_lookup_exact(const struct so
 			return key_info;
...
@@ -287,10 +378,12 @@ static struct tcp_authopt_info *__tcp_authopt_info_get_or_create(struct sock *sk
...
@@ -539,10 +632,45 @@ static int crypto_ahash_buf(struct ahash_request *req, u8 *buf, uint len)
...
+
 ...
 static int tcp_authopt_ahash_traffic_key(struct tcp_authopt_alg_pool *pool,
 					 ...
 					 struct sk_buff *skb,
 					 struct tcp_authopt_info *info,
@@ -779,10 +907,11 @@ static int tcp_authopt_hash_opts(struct tcp_authopt_alg_pool *pool,
...
+				   struct tcp_authopt_info *info,
 				   ...
 				   u8 *macbuf)
 {
@@ -892,20 +1021,161 @@ static int __tcp_authopt_calc_mac(struct sock *sk,
