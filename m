...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 059C41096A7
	for <lists+linux-kselftest@lfdr.de>; Tue, 26 Nov 2019 00:13:38 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1727316AbfKYXKw (ORCPT <rfc822;lists+linux-kselftest@lfdr.de>);
        Mon, 25 Nov 2019 18:10:52 -0500
Received: from hqemgate15.nvidia.com ([216.228.121.64]:3666 "EHLO
        hqemgate15.nvidia.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1727218AbfKYXKv (ORCPT
        <rfc822;linux-kselftest@vger.kernel.org>);
        Mon, 25 Nov 2019 18:10:51 -0500
...
Received: from rnnvemgw01.nvidia.com (10.128.109.123) by HQMAIL101.nvidia.com
 ...
 Transport; Mon, 25 Nov 2019 23:10:47 +0000
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=nvidia.com; s=n1;
        t=1574723442; bh=t+Vlx5vHMdcauybEtz5lgUJ7x33SKKyV2ZEmEGhrFng=;
        h=X-PGP-Universal:From:To:CC:Subject:Date:Message-ID:X-Mailer:
         In-Reply-To:References:MIME-Version:X-NVConfidentiality:
         Content-Type:Content-Transfer-Encoding;
        b=
...
+ * be perfectly matched up with pin*() calls.
 ...
 {
@@ -1506,9 +1504,16 @@ long get_user_pages_remote(struct task_struct *tsk, =
struct mm_struct *mm,
...
@@ -1516,6 +1521,8 @@ long get_user_pages_unlocked(unsigned long start, uns=
igned long nr_pages,
=20
...
c,
@@ -2579,13 +2586,15 @@ struct page *follow_page(struct vm_area_struct *vma=
...
m
@@ -2600,11 +2609,39 @@ struct page *follow_page(struct vm_area_struct *vma=
, unsigned long address,
...
index c0c56888e7cc..b9c15c2444ba 100644
--- a/mm/gup.c
+++ b/mm/gup.c
...
@@ -2392,29 +2427,14 @@ static int __gup_longterm_unlocked(unsigned long st=
art, int nr_pages,
 	return ret;
 }
=20
...
@@ -2454,4 +2474,103 @@ int get_user_pages_fast(unsigned long start, int nr=
_pages,
=20
 	return ret;
 }
