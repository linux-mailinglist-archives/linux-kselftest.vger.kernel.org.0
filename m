Return-Path: <linux-kselftest+bounces-14705-lists+linux-kselftest=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kselftest@lfdr.de
Delivered-To: lists+linux-kselftest@lfdr.de
Received: from ny.mirrors.kernel.org (ny.mirrors.kernel.org [147.75.199.223])
	by mail.lfdr.de (Postfix) with ESMTPS id 4DAA2945AE8
	for <lists+linux-kselftest@lfdr.de>; Fri,  2 Aug 2024 11:24:02 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by ny.mirrors.kernel.org (Postfix) with ESMTPS id 2DEAF1C2291A
	for <lists+linux-kselftest@lfdr.de>; Fri,  2 Aug 2024 09:24:01 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id BCD1E1DB44D;
	Fri,  2 Aug 2024 09:23:39 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=kernel.org header.i=@kernel.org header.b="cIviyvnE"
X-Original-To: linux-kselftest@vger.kernel.org
Received: from smtp.kernel.org (aws-us-west-2-korg-mail-1.web.codeaurora.org [10.30.226.201])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 849C81DB42E;
	Fri,  2 Aug 2024 09:23:39 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=10.30.226.201
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1722590619; cv=none; b=mDk718AD8soSUDHv2ka/Iyz/1M32O3Ah8aoBwEwMP1VKykKLPJwudtDaVVMvOSaoNkF6uxG0lYJGubbKDjeKbbQtBUQr2cz/7m3NjMCrz+GNVqOSMaIWlAThT4G7JmI3reJZ3MdGoH436Il4sGrZCQ1yLgqFcgpcRZ/4L7SQA5w=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1722590619; c=relaxed/simple;
	bh=SQExze31l1INykTR6nfIjT9fsEto3CxuiTMzYkwKWDs=;
	h=From:Date:Subject:MIME-Version:Content-Type:Message-Id:References:
	 In-Reply-To:To:Cc; b=SwLZ4Bk8bZHz7CJag12Hl2fRPGLTCmWGoR73m308DIVtVinjhOZAo8LIXXOVL4QGc7NdAUL2sawnuOqzdOfNgbAgLMBXl9XOoZoAE4OyFSL+njNvj4G5OlmJf2z+yuycZAEl0LncJ1lJMBQar/0wpNrIpzla6mygbtpUTDYKJlo=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dkim=pass (2048-bit key) header.d=kernel.org header.i=@kernel.org header.b=cIviyvnE; arc=none smtp.client-ip=10.30.226.201
Received: by smtp.kernel.org (Postfix) with ESMTPS id 25D22C4AF1C;
	Fri,  2 Aug 2024 09:23:39 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
	s=k20201202; t=1722590619;
	bh=SQExze31l1INykTR6nfIjT9fsEto3CxuiTMzYkwKWDs=;
	h=From:Date:Subject:References:In-Reply-To:To:Cc:Reply-To:From;
	b=
Received: from aws-us-west-2-korg-lkml-1.web.codeaurora.org (localhost.localdomain [127.0.0.1])
	by smtp.lore.kernel.org (Postfix) with ESMTP id 1F5EAC3DA49;
	Fri,  2 Aug 2024 09:23:39 +0000 (UTC)
From: Dmitry Safonov via B4 Relay <devnull+0x7f454c46.gmail.com@kernel.org>
Date: Fri, 02 Aug 2024 10:23:31 +0100
Subject: [PATCH net-next v2 7/7] selftests/net: Add trace events matching
 to tcp_ao
Precedence: bulk
...
Message-Id: <20240802-tcp-ao-selftests-upd-6-12-v2-7-370c99358161@gmail.com>
...
X-Mailer: b4 0.14.0
X-Developer-Signature: v=1; a=ed25519-sha256; t=1722590616; l=54110;
 i=0x7f454c46@gmail.com; s=20240410; h=from:subject:message-id;
 bh=llvT2pMEqXVJuXViYiRpPrv0wMF5tYU7TsDOmUv3qLU=;
 b=0oSI1OynUThSssclHUzXUEQ8X02qKvmB2ZwMRP/XMjadBzqmmCZ6p1sbZLNOmpJuBQQCVRXF2
 uNN/Zm/T5LjBH9Z9+MW0cBCdwKQVTvxh2ed4IlWx99DeJxVw25emPzp
...
index 000000000000..a52c02d7c634
--- /dev/null
