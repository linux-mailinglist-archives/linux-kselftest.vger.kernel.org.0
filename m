...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id B233F60C83C
	for <lists+linux-kselftest@lfdr.de>; Tue, 25 Oct 2022 11:35:26 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S231716AbiJYJfY (ORCPT <rfc822;lists+linux-kselftest@lfdr.de>);
        Tue, 25 Oct 2022 05:35:24 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:40546 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S231726AbiJYJfV (ORCPT
        <rfc822;linux-kselftest@vger.kernel.org>);
        Tue, 25 Oct 2022 05:35:21 -0400
Received: from us-smtp-delivery-124.mimecast.com (us-smtp-delivery-124.mimecast.com [170.10.129.124])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 1D5BB10041B
        for <linux-kselftest@vger.kernel.org>; Tue, 25 Oct 2022 02:35:11 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
        ...
        bh=vSQyxbLi+E08UG6k4y/qH7eYYXcb4sC0BmGjUc5lAZc=;
        b=fNR9+aQc5dJWl3qTXfW3SZfGSGnf/6UwDcHE5BlTEwCDh4KonHpJkSyKj82HlrUIiOVRaw
        nEp9klPn8IiSDr5otgwgaYky/58+TxWgNsfVtlcfXeXsLRbiEVb7fCNV3zy7puw43vDtYW
        RUl3c652BvToVGjqsvoVs6TB+2VD6p4=
Received: from mimecast-mx02.redhat.com (mx3-rdu2.redhat.com
 [66.187.233.73]) by relay.mimecast.com with ESMTP with STARTTLS
 (version=TLSv1.2, cipher=TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384) id
 us-mta-99-BqvcjDxvMYKlUy2ApZpuaA-1; Tue, 25 Oct 2022 05:35:08 -0400
X-MC-Unique: BqvcjDxvMYKlUy2ApZpuaA-1
Received: from smtp.corp.redhat.com (int-mx09.intmail.prod.int.rdu2.redhat.com [10.11.54.9])
        (using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
        (No client certificate requested)
        by mimecast-mx02.redhat.com (Postfix) with ESMTPS id B4BF63801F57;
        Tue, 25 Oct 2022 09:35:07 +0000 (UTC)
Received: from plouf.redhat.com (unknown [10.39.195.44])
        by smtp.corp.redhat.com (Postfix) with ESMTP id 91B324A9254;
...
Subject: [PATCH hid v11 02/14] HID: initial BPF implementation
Date:   Tue, 25 Oct 2022 11:34:46 +0200
Message-Id: <20221025093458.457089-3-benjamin.tissoires@redhat.com>
...
---
 ...
 17 files changed, 1933 insertions(+)
...
index ad767955ee62..5961c0d8f38b 100644
--- a/drivers/hid/Kconfig
+++ b/drivers/hid/Kconfig
@@ -1282,6 +1282,8 @@ config HID_KUNIT_TEST
...
index 9c1d31f63f85..2557a7c09627 100644
...
@@ -2902,6 +2909,11 @@ int hid_check_keys_pressed(struct hid_device *hid)
 }
...
+
 ...
 {
 	int ret;
@@ -2916,6 +2928,10 @@ static int __init hid_init(void)
 		goto err;
 	}
...
+
 	...
 	if (ret)
 		goto err_bus;
@@ -2931,6 +2947,9 @@ static int __init hid_init(void)
