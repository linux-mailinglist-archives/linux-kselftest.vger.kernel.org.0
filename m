Return-Path: <linux-kselftest+bounces-37463-lists+linux-kselftest=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kselftest@lfdr.de
Delivered-To: lists+linux-kselftest@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [139.178.88.99])
	by mail.lfdr.de (Postfix) with ESMTPS id 37CB2B08222
	for <lists+linux-kselftest@lfdr.de>; Thu, 17 Jul 2025 03:11:48 +0200 (CEST)
Received: from smtp.subspace.kernel.org (relay.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-ECDSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id 7DD103A5A72
	for <lists+linux-kselftest@lfdr.de>; Thu, 17 Jul 2025 01:11:13 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 91A281EE02F;
	Thu, 17 Jul 2025 01:10:41 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=google.com header.i=@google.com header.b="NbINUkL+"
X-Original-To: linux-kselftest@vger.kernel.org
Received: from mail-oa1-f74.google.com (mail-oa1-f74.google.com [209.85.160.74])
	(using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 2A4A61C5F14
	for <linux-kselftest@vger.kernel.org>; Thu, 17 Jul 2025 01:10:37 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=209.85.160.74
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1752714641; cv=none; b=s1ZPuL48uNz0vCo2evVM1GRW64qUG/OXr23KRh2VuCBfcbKDLHvhN4XaZofBiz9Y19M2BtZlzTjRjXClQ9+z8pl6aCBvbgMecBrh9nvMOKLJ3aTsW3qq2MSIIMOeZs0pWT1bKrZmfII4dZXRoGiIQTMQW3QzDblEvWIbHOhauos=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1752714641; c=relaxed/simple;
	bh=1XpxJoz/K2MJD8BBZAXa3Bw6DS7+vv4nNmw55hb+Ycg=;
	h=Date:In-Reply-To:Mime-Version:References:Message-ID:Subject:From:
	 To:Cc:Content-Type; b=NgvXHkvWizx8AS6vhKjwVDJL7LU4TnuMUZ3JlpnTYV7fsX7dSeTDSAxDl/oEnnPGMFdqs+mTiZhTsLDjPnT8HTtKAcvRv9HTs+Du0spPcMon/K1Hg96T6/WbDj6UZkXqspVWvEvpNEH5996CyDjL7I17xnVhMJ0B10DRE4ufXRs=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=reject dis=none) header.from=google.com; spf=pass smtp.mailfrom=flex--ynaffit.bounces.google.com; dkim=pass (2048-bit key) header.d=google.com header.i=@google.com header.b=NbINUkL+; arc=none smtp.client-ip=209.85.160.74
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=reject dis=none) header.from=google.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=flex--ynaffit.bounces.google.com
Received: by mail-oa1-f74.google.com with SMTP id 586e51a60fabf-2e9b472cfd1so543059fac.1
        for <linux-kselftest@vger.kernel.org>; Wed, 16 Jul 2025 18:10:37 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=google.com; s=20230601; t=1752714637; x=1753319437; darn=vger.kernel.org;
        h=cc:to:from:subject:message-id:references:mime-version:in-reply-to
         :date:from:to:cc:subject:date:message-id:reply-to;
        bh=l/tbF1KbTwbJnxW66rPAl9E5TP88uI8e3RX84fZNyAU=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20230601; t=1752714637; x=1753319437;
        h=cc:to:from:subject:message-id:references:mime-version:in-reply-to
         :date:x-gm-message-state:from:to:cc:subject:date:message-id:reply-to;
        bh=l/tbF1KbTwbJnxW66rPAl9E5TP88uI8e3RX84fZNyAU=;
        b=
X-Forwarded-Encrypted: i=1; AJvYcCWe5SGfatHVByREjl7PtyMW3heCCsrKYA+m6LsXO5NVFeoEgfiadE5CRr/VVdEUzMDu7SRceHqNGd6L4KEtEfY=@vger.kernel.org
X-Gm-Message-State: AOJu0Yz9aogLyg64QWB67BgbztOD7c+MaxnglPDfPkcOKkA+0RKZ9Sa6
	2CUnmIBJpc1j63YhaoAp0CnVm0D41NAa6AaOI+0IJRZ0iJWMANLvVphxvXWN0hqvShHfpTG3Vd7
	XmUpH3r8ziQ==
X-Google-Smtp-Source: AGHT+IGV3+DRsA6UzsoBZc7ZYYqjmSj+eRlA6NkPsEcis9UhP40vVP8NFuUbNRZeoDXc3m18kKWa5JuVuYhL
X-Received: from oabrc11.prod.google.com ([2002:a05:6871:61cb:b0:2ff:9f42:9536])
 (user=ynaffit job=prod-delivery.src-stubby-dispatcher) by 2002:a05:6870:c115:b0:2ff:90bf:4140
 with SMTP id 586e51a60fabf-2ffb250de08mr3676091fac.34.1752714637207; Wed, 16
 Jul 2025 18:10:37 -0700 (PDT)
Date: Wed, 16 Jul 2025 18:10:08 -0700
...
Message-ID: <20250717011011.3365074-6-ynaffit@google.com>
Subject: [PATCH v4 5/6] binder: Convert binder_alloc selftests to KUnit
...
index 5e49078c9b23..2f6077e96ae6 100644
--- a/drivers/android/tests/binder_alloc_kunit.c
+++ b/drivers/android/tests/binder_alloc_kunit.c
@@ -24,6 +24,265 @@ MODULE_IMPORT_NS("EXPORTED_FOR_KUNIT_TESTING");
...
@@ -59,6 +318,25 @@ static void binder_alloc_test_mmap(struct kunit *test)
...
@@ -152,6 +430,7 @@ static void binder_alloc_test_exit(struct kunit *test)
