Return-Path: <linux-kselftest+bounces-37099-lists+linux-kselftest=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kselftest@lfdr.de
Delivered-To: lists+linux-kselftest@lfdr.de
Received: from ny.mirrors.kernel.org (ny.mirrors.kernel.org [IPv6:2604:1380:45d1:ec00::1])
	by mail.lfdr.de (Postfix) with ESMTPS id CE7BEB01C3D
	for <lists+linux-kselftest@lfdr.de>; Fri, 11 Jul 2025 14:43:03 +0200 (CEST)
Received: from smtp.subspace.kernel.org (relay.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-ECDSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by ny.mirrors.kernel.org (Postfix) with ESMTPS id 2509D5A5D58
	for <lists+linux-kselftest@lfdr.de>; Fri, 11 Jul 2025 12:43:04 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id C70DD2BE7DB;
	Fri, 11 Jul 2025 12:42:58 +0000 (UTC)
X-Original-To: linux-kselftest@vger.kernel.org
Received: from proxmox-new.maurer-it.com (proxmox-new.maurer-it.com [94.136.29.106])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id E49822BDC0F;
	Fri, 11 Jul 2025 12:42:55 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=94.136.29.106
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1752237778; cv=none; b=gE5TzTwXmayL/URRZcSjWDEVCFUYvT6/G+84EcM8MCvFkRPHMqVsf8OBKKOEYOCxjzisuMDfj3N2/8KkfGX6OyRv/fFSJcO9QY80h4VVM1DM9KjZF1o5i48vJuXBfmMdLQo6sAIFZl8Ms2uraMse5kH2QFe6gDf3whvOdfg6zTs=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1752237778; c=relaxed/simple;
	bh=9VWIysiqw3XqJHKXpZWQqvXIDQT5RtIzhFpDHAROb0k=;
	h=From:To:Cc:Subject:Date:Message-Id:MIME-Version; b=tTRtJ+OofeReI2/dCi0jB41SkYRjZR8uIzOkhZQx5W4Ck/PFjSz2R8iyaG/nYd5QMi/voXI5VdxupUGLjbo3sxe42UapMCPcdnivFSm9fe+JAk29DOa+PCMQSuSu1BID8rafOJpMU6IOBDm9C7ITZRokk82/DQFAam1kon4JEy0=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=none (p=none dis=none) header.from=proxmox.com; spf=pass smtp.mailfrom=proxmox.com; arc=none smtp.client-ip=94.136.29.106
Authentication-Results: smtp.subspace.kernel.org; dmarc=none (p=none dis=none) header.from=proxmox.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=proxmox.com
Received: from proxmox-new.maurer-it.com (localhost.localdomain [127.0.0.1])
	by proxmox-new.maurer-it.com (Proxmox) with ESMTP id 1E08A472E4;
	Fri, 11 Jul 2025 14:42:54 +0200 (CEST)
...
Subject: [PATCH net-next v6] ipv6: add `force_forwarding` sysctl to enable per-interface forwarding
Date: Fri, 11 Jul 2025 14:42:41 +0200
Message-Id: <20250711124243.526735-1-g.goller@proxmox.com>
...
index ba2ec7c870cc..580aed034849 100644
...
@@ -6747,6 +6753,75 @@ static int addrconf_sysctl_disable_policy(const struct ctl_table *ctl, int write
 	return ret;
 }
...
@@ -7217,6 +7292,13 @@ static const struct ctl_table addrconf_sysctl[] = {
 		.extra1		= SYSCTL_ZERO,
 		.extra2		= SYSCTL_TWO,
 	},
+	{
