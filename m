...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id EADD6433D5E
	for <lists+linux-kselftest@lfdr.de>; Tue, 19 Oct 2021 19:24:49 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S233460AbhJSR1B (ORCPT <rfc822;lists+linux-kselftest@lfdr.de>);
        Tue, 19 Oct 2021 13:27:01 -0400
Received: from mail.kernel.org ([198.145.29.99]:55072 "EHLO mail.kernel.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S233580AbhJSR1B (ORCPT <rfc822;linux-kselftest@vger.kernel.org>);
        Tue, 19 Oct 2021 13:27:01 -0400
Received: by mail.kernel.org (Postfix) with ESMTPSA id 82207610E5;
        Tue, 19 Oct 2021 17:24:47 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
        s=k20201202; t=1634664288;
        bh=JiE3xeGer0P5l/7CDlHYGqp0M/WGIiiRX1HBELbIocA=;
        h=From:To:Cc:Subject:Date:In-Reply-To:References:From;
        b=
...
Subject: [PATCH v3 26/42] arm64/sme: Implement ZA context switching
Date:   Tue, 19 Oct 2021 18:22:31 +0100
Message-Id: <20211019172247.3045838-27-broonie@kernel.org>
X-Mailer: git-send-email 2.30.2
In-Reply-To: <20211019172247.3045838-1-broonie@kernel.org>
References: <20211019172247.3045838-1-broonie@kernel.org>
MIME-Version: 1.0
X-Developer-Signature: v=1; a=openpgp-sha256; l=7017; h=from:subject; bh=JiE3xeGer0P5l/7CDlHYGqp0M/WGIiiRX1HBELbIocA=; b=owEBbQGS/pANAwAKASTWi3JdVIfQAcsmYgBhbv7YFbV4wbULFPc8VjyMwSMzTVz8FbaiLveFYuH/ Z/Mo5GSJATMEAAEKAB0WIQSt5miqZ1cYtZ/in+ok1otyXVSH0AUCYW7+2AAKCRAk1otyXVSH0D7bB/ 9F6D+COdOf+nmljAetIGCQEzjOKtnG/pOPpmO6lkaDdjVxMpBLBjwX99bjl6bTlzIXK7j/5QvLTAV1 MFcFDwk07uxlcChpcCIWUBPpTgfGYrfmpOyivEg9E33jRi8NGI+YhKeNqcH6Fh6TOD/KctHK4Oa8Ay GpE8Sqw0P22sLHWQIYn9IvweMTRyH+zEEkuAh8SFdjy7+qRrToDySA1LWPE92p6p091lFrarlrUs9T gldmT1+JinCHtEQ9lypecSVtWO+SGa7jSRUQq3TN6l83+dRm0gCb+HPoEfs/ysFaGKTgtAOzmJ4hpH c0ucVHauZPsamf5gn5hov75Rukyebs
...
index d11bbae3ede5..426f6be0f466 100644
...
+			sme_save_state(last->za_state, last->sme_vl);
 		...
 		if (thread_sm_enabled(&current->thread)) {
@@ -1473,6 +1475,7 @@ static void fpsimd_bind_task_to_cpu(void)
...
@@ -1489,7 +1492,8 @@ static void fpsimd_bind_task_to_cpu(void)
 }
...
@@ -1499,6 +1503,7 @@ void fpsimd_bind_state_to_cpu(struct user_fpsimd_state *st, void *sve_state,
