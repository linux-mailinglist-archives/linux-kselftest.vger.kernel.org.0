Return-Path: <linux-kselftest+bounces-31107-lists+linux-kselftest=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kselftest@lfdr.de
Delivered-To: lists+linux-kselftest@lfdr.de
Received: from sy.mirrors.kernel.org (sy.mirrors.kernel.org [IPv6:2604:1380:40f1:3f00::1])
	by mail.lfdr.de (Postfix) with ESMTPS id F00A0A92DFC
	for <lists+linux-kselftest@lfdr.de>; Fri, 18 Apr 2025 01:17:25 +0200 (CEST)
Received: from smtp.subspace.kernel.org (relay.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-ECDSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sy.mirrors.kernel.org (Postfix) with ESMTPS id 3A1BF7A86A8
	for <lists+linux-kselftest@lfdr.de>; Thu, 17 Apr 2025 23:16:15 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 3EF71228375;
	Thu, 17 Apr 2025 23:15:54 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=google.com header.i=@google.com header.b="aJYz+XlT"
X-Original-To: linux-kselftest@vger.kernel.org
Received: from mail-pl1-f202.google.com (mail-pl1-f202.google.com [209.85.214.202])
	(using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 5D102224AE4
	for <linux-kselftest@vger.kernel.org>; Thu, 17 Apr 2025 23:15:50 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=209.85.214.202
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1744931754; cv=none; b=sqem6/Xb19PaYuUi0SEHDXbhQ3AokLSTnY42IDb1ynqUSIRBDFGHBB2n1CWt+qairb/CcgAV6H553lJE+Bqz19ocPVr5M1hoXkojF7Dvys3hwNsdJvTJs+OYJp5/Xs7UK7dPD6jR9Q0Nld1QAe0dZYxCRr5D8B8dh43UAO/RW5k=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1744931754; c=relaxed/simple;
	bh=pqeasC5nRazG4l61dAwT5GatJrW7g+tNxzgqSn/nY44=;
	h=Date:In-Reply-To:Mime-Version:References:Message-ID:Subject:From:
	 To:Cc:Content-Type; b=uo+reigGPqWpCpslaD0u0OFlhusUpyWzCjFjUdm6LVwxGzXS2/VneohvlXOLSfF5dn67bo7Pjzm8X0LOIYXsm8DSZ251ZFisJKZmViWVg5edHGzH7B+LUaDLH4djnyuloboSxpmEMNTMioFGmn41BuxMBon6cMatVMJjtttF6QA=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=reject dis=none) header.from=google.com; spf=pass smtp.mailfrom=flex--almasrymina.bounces.google.com; dkim=pass (2048-bit key) header.d=google.com header.i=@google.com header.b=aJYz+XlT; arc=none smtp.client-ip=209.85.214.202
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=reject dis=none) header.from=google.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=flex--almasrymina.bounces.google.com
Received: by mail-pl1-f202.google.com with SMTP id d9443c01a7336-22651aca434so13829115ad.1
        for <linux-kselftest@vger.kernel.org>; Thu, 17 Apr 2025 16:15:50 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=google.com; s=20230601; t=1744931750; x=1745536550; darn=vger.kernel.org;
        h=cc:to:from:subject:message-id:references:mime-version:in-reply-to
         :date:from:to:cc:subject:date:message-id:reply-to;
        bh=7oh7PGOrfKnTmzR73nCDo3WdGCzljPcJ8cA407umsus=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20230601; t=1744931750; x=1745536550;
        h=cc:to:from:subject:message-id:references:mime-version:in-reply-to
         :date:x-gm-message-state:from:to:cc:subject:date:message-id:reply-to;
        bh=7oh7PGOrfKnTmzR73nCDo3WdGCzljPcJ8cA407umsus=;
        b=
X-Forwarded-Encrypted: i=1; AJvYcCXmlbadulYTuUvnGZg6MLvkkzM9JNIPDWhoxjKseovn0y/1FsPO3TiLo6vdJZHYqbquHRwKw1E5mvjlrIADwtE=@vger.kernel.org
X-Gm-Message-State: AOJu0YyeP5Qguoi4lO7OH7cSi3cKXgrO56g5FOlFc5nZugzp+PgEs6bQ
	Ar75xZtW16Dxj/Hp02LFvpXoJgwWhWdj4EIS97PNcgS3IxPimM6tXtmY6mWzGQvIr0HTJ7ccmNA
	Q8V/qEohlwE0o4F/8sUMNQg==
X-Google-Smtp-Source: AGHT+IHsUYygWXotGK1dmigTeHlJMy8Yw32fP40gei4qFMbnCv9w4A1lwGHCmAvCqjNv/KcEJd6DiDnEryt0Bil8+g==
X-Received: from plrf20.prod.google.com ([2002:a17:902:ab94:b0:223:f487:afc6])
 (user=almasrymina job=prod-delivery.src-stubby-dispatcher) by
 2002:a17:902:f548:b0:224:1943:c5c with SMTP id d9443c01a7336-22c5359c195mr11259525ad.15.1744931749710;
 Thu, 17 Apr 2025 16:15:49 -0700 (PDT)
Date: Thu, 17 Apr 2025 23:15:35 +0000
...
Message-ID: <20250417231540.2780723-5-almasrymina@google.com>
Subject: [PATCH net-next v9 4/9] net: devmem: Implement TX path
...
---
 ...
 12 files changed, 341 insertions(+), 63 deletions(-)

diff --git a/include/linux/skbuff.h b/include/linux/skbuff.h
index beb084ee4f4d..5d62e8e77546 100644
...
index dca2ff7cf692..fb75c30b8394 100644
--- a/net/core/devmem.c
+++ b/net/core/devmem.c
@@ -16,6 +16,7 @@
...
index 5e42f800dfcf..5f44f7a3cbdb 100644
...
+					 info->extack);
 	if (IS_ERR(binding)) {
 		err = PTR_ERR(binding);
 		goto err_unlock;
@@ -934,10 +935,69 @@ int netdev_nl_bind_rx_doit(struct sk_buff *skb, struct genl_info *info)
 	return err;
 }
...
index 00c22bce98e4..4159107f1666 100644
--- a/net/core/skbuff.c
+++ b/net/core/skbuff.c
...
index b64df2463300..9dd298904035 100644
--- a/net/core/sock.c
+++ b/net/core/sock.c
...
index e0e96f8fd47c..9f7cd3344496 100644
--- a/net/ipv4/tcp.c
+++ b/net/ipv4/tcp.c
