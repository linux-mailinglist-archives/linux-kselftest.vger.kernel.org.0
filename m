...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 58DEC258B7B
	for <lists+linux-kselftest@lfdr.de>; Tue,  1 Sep 2020 11:27:43 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726510AbgIAJ1l (ORCPT <rfc822;lists+linux-kselftest@lfdr.de>);
        Tue, 1 Sep 2020 05:27:41 -0400
Received: from foss.arm.com ([217.140.110.172]:39136 "EHLO foss.arm.com"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1726126AbgIAJ1k (ORCPT <rfc822;linux-kselftest@vger.kernel.org>);
        Tue, 1 Sep 2020 05:27:40 -0400
Received: from usa-sjc-imap-foss1.foss.arm.com (unknown [10.121.207.14])
        by usa-sjc-mx-foss1.foss.arm.com (Postfix) with ESMTP id 7D3C31045;
        Tue,  1 Sep 2020 02:27:38 -0700 (PDT)
Received: from a077416.arm.com (unknown [10.57.6.112])
        by usa-sjc-imap-foss1.foss.arm.com (Postfix) with ESMTPA id 237C83F71F;
...
Subject: [PATCH 1/6] kselftest/arm64: Add utilities and a test to validate mte memory
Date:   Tue,  1 Sep 2020 14:57:14 +0530
Message-Id: <20200901092719.9918-2-amit.kachhap@arm.com>
...
new file mode 100644
index 000000000000..9710854585ad
--- /dev/null
...
+}
+
+unsigned long read_sysfs(char *str)
+{
+	FILE *f;
+	unsigned long val = 0;
+
...
+}
+
+void write_sysfs(char *str, unsigned long val)
+{
+	FILE *f;
+
+	f = fopen(str, "w");
...
new file mode 100644
index 000000000000..4a6e44bc4278
--- /dev/null
...
new file mode 100644
index 000000000000..cdcf3614d29e
--- /dev/null
