...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id E8BE3737C27
	for <lists+linux-kselftest@lfdr.de>; Wed, 21 Jun 2023 09:36:25 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S231478AbjFUH0K (ORCPT <rfc822;lists+linux-kselftest@lfdr.de>);
        Wed, 21 Jun 2023 03:26:10 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:56560 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S231480AbjFUHZM (ORCPT
        <rfc822;linux-kselftest@vger.kernel.org>);
        Wed, 21 Jun 2023 03:25:12 -0400
Received: from madras.collabora.co.uk (madras.collabora.co.uk [46.235.227.172])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id E24701BD0;
        Wed, 21 Jun 2023 00:25:03 -0700 (PDT)
Received: from localhost.localdomain (unknown [182.179.162.32])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange X25519 server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        (Authenticated sender: usama.anjum)
        by madras.collabora.co.uk (Postfix) with ESMTPSA id 43D9D6606F8E;
        Wed, 21 Jun 2023 08:24:55 +0100 (BST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=collabora.com;
        s=mail; t=1687332302;
        bh=Ox3j58Y1JGH/VEiv1MW2YGMXoiGR9g8eET7GZgs/nnQ=;
        h=From:To:Cc:Subject:Date:In-Reply-To:References:From;
        b=
...
Subject: [PATCH v20 5/5] selftests: mm: add pagemap ioctl tests
Date:   Wed, 21 Jun 2023 12:24:04 +0500
Message-Id: <20230621072404.2918101-6-usama.anjum@collabora.com>
...
index 000000000000..b77a216f2953
--- /dev/null
...
+
+	fd = open(__FILE__".tmp2", O_RDWR | O_CREAT);
+	if (fd < 0)
