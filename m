...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 34BACD2896
	for <lists+linux-kselftest@lfdr.de>; Thu, 10 Oct 2019 14:00:45 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1727320AbfJJMAo (ORCPT <rfc822;lists+linux-kselftest@lfdr.de>);
        Thu, 10 Oct 2019 08:00:44 -0400
Received: from mail-wr1-f48.google.com ([209.85.221.48]:41068 "EHLO
        mail-wr1-f48.google.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1728168AbfJJMAo (ORCPT
        <rfc822;linux-kselftest@vger.kernel.org>);
        Thu, 10 Oct 2019 08:00:44 -0400
Received: by mail-wr1-f48.google.com with SMTP id q9so7543431wrm.8
        for <linux-kselftest@vger.kernel.org>; Thu, 10 Oct 2019 05:00:39 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=linaro.org; s=google;
        h=from:date:to:message-id:subject:mime-version;
        bh=v+ixMnwUMLCjeMqKDlY96THhqSD0CvYUDTqS7fBsgVs=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20161025;
        h=x-gm-message-state:from:date:to:message-id:subject:mime-version;
        bh=v+ixMnwUMLCjeMqKDlY96THhqSD0CvYUDTqS7fBsgVs=;
        b=
X-Gm-Message-State: APjAAAVr4mpgsbrJa9kuugUCBp+RHIg+St4dUjGNxUn+DnFOIg9VMcUW
        aBdHbM5hM/9WTLJPC+frwHejYg==
X-Google-Smtp-Source: APXvYqyPU8+LnAQhWgJJjIPZryeZ8nalEzdLxQGMfjw2XZzxf2OOwuSg4k+TAfhFLsy76BnTy+LicQ==
X-Received: by 2002:a5d:6a02:: with SMTP id m2mr2756609wru.120.1570708838279;
        Thu, 10 Oct 2019 05:00:38 -0700 (PDT)
Received: from 172.17.0.4 (ci.linaro.org. [88.99.136.175])
        by smtp.gmail.com with ESMTPSA id z6sm5655171wro.16.2019.10.10.05.00.37
        (version=TLS1 cipher=ECDHE-RSA-AES128-SHA bits=128/128);
        Thu, 10 Oct 2019 05:00:37 -0700 (PDT)
From:   ci_notify@linaro.org
X-Google-Original-From: linaro-infrastructure-errors@lists.linaro.org
Date:   Thu, 10 Oct 2019 12:00:36 +0000 (UTC)
To:     lkft-triage@lists.linaro.org, dan.rue@linaro.org,
        anders.roxell@linaro.org, naresh.kamboju@linaro.org,
        shuah@kernel.org, linux-kselftest@vger.kernel.org
Message-ID: <551993964.6242.1570708837608.JavaMail.javamailuser@localhost>
Subject: next-20191010 kselftest results
MIME-Version: 1.0
Content-Type: multipart/mixed; 
        boundary="----=_Part_6241_221399887.1570708836934"
...
------=_Part_6241_221399887.1570708836934
...
Test details: https://qa-reports.linaro.org/lkft/linux-next-oe/build/next-20191010

Regressions (compared to build next-20191009)
------------------------------------------------------------------------
juno-r2 - arm64:                                                                                                      
 kselftest:                                                                                         
    * net_so_txtime.sh                                                                                                         
...
Fixes (compared to build next-20191009)                                                                   
------------------------------------------------------------------------                                               
juno-r2 - arm64:                                                                                                      
 kselftest:                                                                                         
    * bpf_test_sock_addr.sh                                                                                                         
...
In total:
------------------------------------------------------------------------
Ran 1957 total tests in the following environments and test suites.
pass 1100
fail 714
xfail 0
skip 143
