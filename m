...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 0AE3D33120C
	for <lists+linux-kselftest@lfdr.de>; Mon,  8 Mar 2021 16:23:21 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S230047AbhCHPWr (ORCPT <rfc822;lists+linux-kselftest@lfdr.de>);
        Mon, 8 Mar 2021 10:22:47 -0500
Received: from out1-smtp.messagingengine.com ([66.111.4.25]:49049 "EHLO
        out1-smtp.messagingengine.com" rhost-flags-OK-OK-OK-OK)
        by vger.kernel.org with ESMTP id S229904AbhCHPWb (ORCPT
        <rfc822;linux-kselftest@vger.kernel.org>);
        Mon, 8 Mar 2021 10:22:31 -0500
Received: from compute4.internal (compute4.nyi.internal [10.202.2.44])
        by mailout.nyi.internal (Postfix) with ESMTP id AAD475C00AB;
        Mon,  8 Mar 2021 10:22:30 -0500 (EST)
Received: from mailfrontend1 ([10.202.2.162])
  by compute4.internal (MEProxy); Mon, 08 Mar 2021 10:22:30 -0500
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=sent.com; h=from
        :to:cc:subject:date:message-id:reply-to:mime-version
        :content-transfer-encoding; s=fm3; bh=fl2TiFQppyK7JxYeoDEdtWNuAb
        AE0QkijJQh4jIaQxk=; b=h8rXRswp8iDfncYTsyFoG7kH/9DPSKSkXoSxrumBBB
        
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=
        messagingengine.com; h=cc:content-transfer-encoding:date:from
        :message-id:mime-version:reply-to:subject:to:x-me-proxy
        :x-me-proxy:x-me-sender:x-me-sender:x-sasl-enc; s=fm2; bh=fl2TiF
        QppyK7JxYeoDEdtWNuAbAE0QkijJQh4jIaQxk=; b=MORor1CUKYrkv9t3x54+wb
        
        ==
X-ME-Sender: <xms:NUFGYEjDn-3N92k0HA9T3C52ICY0XedJzpwVwIqXkxYZgZ74akVxHA>
    <xme:NUFGYOj_ebJ-DJSjfbiE0yxV3lenZuYHxUy94q8JHbfdXbv24LLQUxJKvA4bZpmYz
    wAWkQc60fckYvbWIA>
X-ME-Proxy-Cause: gggruggvucftvghtrhhoucdtuddrgeduledruddugedgudefucetufdoteggodetrfdotf
...
X-ME-Proxy: <xmx:NUFGYMIi0uh9QII5N-zmiXid_nse-rwGtdwR0yIkZjaL11NR01qxfg>
    <xmx:NUFGYFFyhzdityy8sYLpGgF8t9e1j2ZfBGIEVQw8CK322PS3LTTSLQ>
    <xmx:NUFGYIS6RUy0Kb2Pf0kT23xnmKtZHpp761Tnorh9ECZzc0oBXvPbJg>
    <xmx:NkFGYNjnE24NBIE1hfNvjcXH3n7nIpVektsFa_aJGiVr2VegbA7EdA>
Received: from Threadripper.local (209-6-71-213.s2259.c3-0.abr-cbr1.sbo-abr.ma.cable.rcncustomer.com [209.6.71.213])
        by mail.messagingengine.com (Postfix) with ESMTPA id 3B2E124005D;
        Mon,  8 Mar 2021 10:22:29 -0500 (EST)
...
Date:   Mon,  8 Mar 2021 10:22:21 -0500
Message-Id: <20210308152221.28555-1-zi.yan@sent.com>
...
@@ -2971,10 +2972,107 @@ static int split_huge_pages_set(void *data, u64 va=
l)
...
--- a/mm/migrate.c
+++ b/mm/migrate.c
@@ -1913,7 +1913,7 @@ static int do_pages_stat(struct mm_struct *mm, unsign=
ed long nr_pages,
