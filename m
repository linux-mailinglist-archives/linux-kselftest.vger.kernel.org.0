...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 7492513361E
	for <lists+linux-kselftest@lfdr.de>; Tue,  7 Jan 2020 23:47:04 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1727983AbgAGWqn (ORCPT <rfc822;lists+linux-kselftest@lfdr.de>);
        Tue, 7 Jan 2020 17:46:43 -0500
Received: from hqnvemgate26.nvidia.com ([216.228.121.65]:4869 "EHLO
        hqnvemgate26.nvidia.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1727739AbgAGWqR (ORCPT
...
+ * be perfectly matched up with pin*() calls.
 ...
 {
@@ -1514,9 +1512,16 @@ long get_user_pages_remote(struct task_struct *tsk, =
struct mm_struct *mm,
...
@@ -1524,6 +1529,8 @@ long get_user_pages_unlocked(unsigned long start, uns=
igned long nr_pages,
=20
...
c,
@@ -2587,13 +2594,15 @@ struct page *follow_page(struct vm_area_struct *vma=
...
m
@@ -2608,11 +2617,39 @@ struct page *follow_page(struct vm_area_struct *vma=
, unsigned long address,
...
--- a/mm/gup.c
+++ b/mm/gup.c
@@ -194,6 +194,10 @@ static struct page *follow_page_pte(struct vm_area_str=
uct *vma,
 	spinlock_t *ptl;
 	pte_t *ptep, pte;
=20
...
@@ -811,7 +815,7 @@ static long __get_user_pages(struct task_struct *tsk, s=
truct mm_struct *mm,
=20
...
@@ -1035,7 +1039,16 @@ static __always_inline long __get_user_pages_locked(=
...
=20
 	pages_done =3D 0;
@@ -1606,11 +1619,19 @@ static __always_inline long __gup_longterm_locked(s=
...
@@ -1636,6 +1657,16 @@ long get_user_pages_remote(struct task_struct *tsk, =
struct mm_struct *mm,
 }
...
@@ -1647,6 +1678,13 @@ long get_user_pages(unsigned long start, unsigned lo=
ng nr_pages,
 		unsigned int gup_flags, struct page **pages,
 		struct vm_area_struct **vmas)
 {
...
@@ -2389,30 +2427,15 @@ static int __gup_longterm_unlocked(unsigned long st=
art, int nr_pages,
 	return ret;
 }
=20
...
@@ -2452,4 +2475,103 @@ int get_user_pages_fast(unsigned long start, int nr=
_pages,
=20
 	return ret;
 }
