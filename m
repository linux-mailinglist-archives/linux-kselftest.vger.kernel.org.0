...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id E3EA7436A1D
	for <lists+linux-kselftest@lfdr.de>; Thu, 21 Oct 2021 20:08:29 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S231707AbhJUSKp (ORCPT <rfc822;lists+linux-kselftest@lfdr.de>);
        Thu, 21 Oct 2021 14:10:45 -0400
Received: from mail.kernel.org ([198.145.29.99]:55446 "EHLO mail.kernel.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S229914AbhJUSKp (ORCPT <rfc822;linux-kselftest@vger.kernel.org>);
        Thu, 21 Oct 2021 14:10:45 -0400
Received: by mail.kernel.org (Postfix) with ESMTPSA id 3191761B00;
        Thu, 21 Oct 2021 18:08:27 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
        s=k20201202; t=1634839708;
        bh=SLZ2G+x1UrH74hcarG5Miz2q1vL0OuECrnm2GX8YVfA=;
        h=From:To:Cc:Subject:Date:In-Reply-To:References:From;
        b=
...
Subject: [PATCH v4 10/33] arm64/sme: Basic enumeration support
Date:   Thu, 21 Oct 2021 19:06:59 +0100
Message-Id: <20211021180722.3699248-11-broonie@kernel.org>
X-Mailer: git-send-email 2.30.2
In-Reply-To: <20211021180722.3699248-1-broonie@kernel.org>
References: <20211021180722.3699248-1-broonie@kernel.org>
MIME-Version: 1.0
X-Developer-Signature: v=1; a=openpgp-sha256; l=11866; h=from:subject; bh=SLZ2G+x1UrH74hcarG5Miz2q1vL0OuECrnm2GX8YVfA=; b=owEBbQGS/pANAwAKASTWi3JdVIfQAcsmYgBhcaxGKoiC8LRy6VDsrdGq37oRVtWSN/kPTcVu//MO Eh5AdXSJATMEAAEKAB0WIQSt5miqZ1cYtZ/in+ok1otyXVSH0AUCYXGsRgAKCRAk1otyXVSH0Ke2B/ 9fQTj8LwGpfT6up5U8RTG+b9cuoh/7PJxCIr49Nuanm6IJMEmlrxXcXSBnCbN1202hYhP8oDHU4LZ/ NGcpEag1gEFAUv1EtrRpyn51TlmzdcQ2h6IeMPBuO5E93hiEUjFVerkU4dR+P4dzkRAsrXfyn0y+n+ xzWvzokI7jnGZUVl2206LxQJG8lJEaA0Vg5wzMedw1Ms4+L096Hy0+HUKB16qqLcA6epcMRo7WRyaG M5G7BzxAEQRXZ4fra4wT3S6sgOf1SiKiEb0Eny3uTfqdVMyDdIaGiT2gmFwG44v3FuHrYs6dtrh/KK AJfusN1Lcsk6qYcyOILRooZjL9koWc
...
index 763891f14496..8416e4889596 100644
--- a/arch/arm64/kernel/fpsimd.c
+++ b/arch/arm64/kernel/fpsimd.c
@@ -983,6 +983,21 @@ void fpsimd_release_task(struct task_struct *dead_task)
...
+
  ...
  * Trapped SVE access
  *
@@ -1525,6 +1540,10 @@ static int __init fpsimd_init(void)
