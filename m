Return-Path: <linux-kselftest+bounces-22981-lists+linux-kselftest=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kselftest@lfdr.de
Delivered-To: lists+linux-kselftest@lfdr.de
Received: from am.mirrors.kernel.org (am.mirrors.kernel.org [147.75.80.249])
	by mail.lfdr.de (Postfix) with ESMTPS id 344439E8E08
	for <lists+linux-kselftest@lfdr.de>; Mon,  9 Dec 2024 09:56:14 +0100 (CET)
Received: from smtp.subspace.kernel.org (relay.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-ECDSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by am.mirrors.kernel.org (Postfix) with ESMTPS id 3A9641885D46
	for <lists+linux-kselftest@lfdr.de>; Mon,  9 Dec 2024 08:55:30 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 71DE4217F5D;
	Mon,  9 Dec 2024 08:53:17 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=openvpn.net header.i=@openvpn.net header.b="deKWD6DT"
X-Original-To: linux-kselftest@vger.kernel.org
Received: from mail-wr1-f46.google.com (mail-wr1-f46.google.com [209.85.221.46])
	(using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id A9FDF215711
	for <linux-kselftest@vger.kernel.org>; Mon,  9 Dec 2024 08:53:12 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=209.85.221.46
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1733734397; cv=none; b=uyva7oDU5Zkt3d0xvJPTr+XADjF12PKJbS3YZz/Ssomp2JUtC6C+H8CPVFOL14C9uc6IpUKdUaGu2ZgLgYfloiFbickxV+7ZCgOiSKwYi/3tN4L86c/dd4R46nI08CEE4h2iQqCPpZVyHsZaQv5RC8iKu6TljGA6lPz0C7eQC2E=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1733734397; c=relaxed/simple;
	bh=owTv8cxOCtngOA4MoDX3frrB6ITVhHThBgZUzYEyu5w=;
	h=From:Date:Subject:MIME-Version:Content-Type:Message-Id:References:
	 In-Reply-To:To:Cc; b=HDM9g7ddC+GoEq/8Ui9sE/wvw5tdoQgg/oVoZzzPEA0uvrq3Ma3JRjhTTzkKPs5Dpy2SqM54n5/90ZdCTuMS4VbXOOQtEAPrdmzK6UxBDDIqRbHorKgmhhDMLT31CpqDe/pEuNd4KDo4rIYNjEnQU0VLGsckg2Qgm4lEk239KmM=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=openvpn.net; spf=pass smtp.mailfrom=openvpn.com; dkim=pass (2048-bit key) header.d=openvpn.net header.i=@openvpn.net header.b=deKWD6DT; arc=none smtp.client-ip=209.85.221.46
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=openvpn.net
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=openvpn.com
Received: by mail-wr1-f46.google.com with SMTP id ffacd0b85a97d-385e06af753so1774964f8f.2
        for <linux-kselftest@vger.kernel.org>; Mon, 09 Dec 2024 00:53:12 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=openvpn.net; s=google; t=1733734390; x=1734339190; darn=vger.kernel.org;
        h=cc:to:in-reply-to:references:message-id:content-transfer-encoding
         :mime-version:subject:date:from:from:to:cc:subject:date:message-id
         :reply-to;
        bh=f2f6PGnnCR7kNavy4YYaOYh3yJa2sspg0YYXPAz07bc=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20230601; t=1733734390; x=1734339190;
        h=cc:to:in-reply-to:references:message-id:content-transfer-encoding
         :mime-version:subject:date:from:x-gm-message-state:from:to:cc
         :subject:date:message-id:reply-to;
        bh=f2f6PGnnCR7kNavy4YYaOYh3yJa2sspg0YYXPAz07bc=;
        b=
X-Forwarded-Encrypted: i=1; AJvYcCVaCsO2dCnjjEo8v88FqWudPJTqt0LHpOKaVQoUA5U8opWwswQm+7UWM7mNXtjflhfRLaC0soiV1gkX5qD1k/k=@vger.kernel.org
X-Gm-Message-State: AOJu0YzNOMO1XUrWX7Bz8VkpgLQMSj3N1l8bnx/2qWzFColDQd0ar+AX
	m8RwPXfwWwyjFup0E92SynNLSgLWxhXUtx1GpS1YfLL2Rjtxo8hqOJ1JKAt5BS2iUUsSlSHgKM4
	O
X-Gm-Gg: ASbGncscgdUcPbvgT5zz/XKZnWTdPM1el+hKM2jHP3+q5v1px+DjPXFhrApO85aAyij
	mzFZID1lKYCpwA0Q+YFJBCw3qNmevWYqNltU71Tn39ks8ChO9PEUIgVHvOBo3VqrJgzJrmSyVQp
	pzBkg2lYYxJPRz5w2+TvHHX4TH0Hjvp1FwSrYJm62MzgJZI0e8FyrVcfianKgLtb1k+TUmB49zw
	KwQvgqSKjxSVeoOmRpAvB+jvDnD58IYDbBtwaKqeX1fhSf9GbuIfU2xm921
X-Google-Smtp-Source: AGHT+IFBoXPxzdWBJFbDw/FfwAD15s76v34U8EqCTveReaZE+LVZL3aW4F2Y78b+QXoGS9XpX2aknw==
X-Received: by 2002:a05:6000:184d:b0:385:fa20:658b with SMTP id ffacd0b85a97d-3862b368c7bmr8095032f8f.24.1733734389748;
        Mon, 09 Dec 2024 00:53:09 -0800 (PST)
Received: from serenity.mandelbit.com ([2001:67c:2fbc:1:c60f:6f50:7258:1f7])
        by smtp.gmail.com with ESMTPSA id ffacd0b85a97d-38621fbbea8sm12439844f8f.97.2024.12.09.00.53.08
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Mon, 09 Dec 2024 00:53:09 -0800 (PST)
From: Antonio Quartulli <antonio@openvpn.net>
Date: Mon, 09 Dec 2024 09:53:18 +0100
Subject: [PATCH net-next v14 09/22] ovpn: implement packet processing
Precedence: bulk
...
Message-Id: <20241209-b4-ovpn-v14-9-ea243cf16417@openvpn.net>
...
X-Mailer: b4 0.14.2
X-Developer-Signature: v=1; a=openpgp-sha256; l=41390; i=antonio@openvpn.net;
 h=from:subject:message-id; bh=owTv8cxOCtngOA4MoDX3frrB6ITVhHThBgZUzYEyu5w=;
 b=
 vb6odN4iXHpj9YKZOydLrfxBGXssFaF6CbmL9rsSupjoX52O
...
---
 ...
 14 files changed, 1122 insertions(+), 11 deletions(-)
...
index 9f5c6b06c79681048f750fce89e9683da41ea642..a6db02f712203430942e3908480026f4dbac673a 100644
...
@@ -56,33 +60,139 @@ static void ovpn_netdev_write(struct ovpn_peer *peer, struct sk_buff *skb)
...
+		aead_request_free(ovpn_skb_cb(skb)->req);
 	...
 	if (unlikely(ret < 0))
 		goto err;
@@ -102,13 +212,28 @@ static void ovpn_encrypt_post(struct sk_buff *skb, int ret)
 err:
 	if (unlikely(skb))
...
@@ -118,7 +243,8 @@ static bool ovpn_encrypt_one(struct ovpn_peer *peer, struct sk_buff *skb)
 		return false;
 	}
...
index d89c82aae2c7646f8c40cdde5bfe364c8b46c659..456fd70ccd2a7e37f0ad1732ca9f5a07f2f54a97 100644
...
@@ -286,6 +292,29 @@ struct ovpn_peer *ovpn_peer_get_by_dst(struct ovpn_priv *ovpn,
 	return peer;
 }
