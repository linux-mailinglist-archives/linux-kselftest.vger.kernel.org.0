...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id CB47518DC81
	for <lists+linux-kselftest@lfdr.de>; Sat, 21 Mar 2020 01:31:18 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1727674AbgCUAbR (ORCPT <rfc822;lists+linux-kselftest@lfdr.de>);
        Fri, 20 Mar 2020 20:31:17 -0400
Received: from hqnvemgate25.nvidia.com ([216.228.121.64]:7553 "EHLO
        hqnvemgate25.nvidia.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1726955AbgCUAbR (ORCPT
        <rfc822;linux-kselftest@vger.kernel.org>);
        Fri, 20 Mar 2020 20:31:17 -0400
Received: from hqpgpgate101.nvidia.com (Not Verified[216.228.121.13]) by hqnvemgate25.nvidia.com (using TLS: TLSv1.2, DES-CBC3-SHA)
        id <B5e7560200000>; Fri, 20 Mar 2020 17:30:24 -0700
Received: from hqmail.nvidia.com ([172.20.161.6])
  by hqpgpgate101.nvidia.com (PGP Universal service);
  Fri, 20 Mar 2020 17:31:14 -0700
X-PGP-Universal: processed;
        by hqpgpgate101.nvidia.com on Fri, 20 Mar 2020 17:31:14 -0700
Received: from HQMAIL109.nvidia.com (172.20.187.15) by HQMAIL105.nvidia.com
 (172.20.187.12) with Microsoft SMTP Server (TLS) id 15.0.1473.3; Sat, 21 Mar
 2020 00:31:14 +0000
Received: from hqnvemgw03.nvidia.com (10.124.88.68) by HQMAIL109.nvidia.com
 (172.20.187.15) with Microsoft SMTP Server (TLS) id 15.0.1473.3 via Frontend
 Transport; Sat, 21 Mar 2020 00:31:14 +0000
Received: from rcampbell-dev.nvidia.com (Not Verified[10.110.48.66]) by hqnvemgw03.nvidia.com with Trustwave SEG (v7,5,8,10121)
        id <B5e7560520000>; Fri, 20 Mar 2020 17:31:14 -0700
...
Subject: [PATCH v8 1/3] mm/hmm/test: add selftest driver for HMM
Date:   Fri, 20 Mar 2020 17:31:06 -0700
Message-ID: <20200321003108.22941-2-rcampbell@nvidia.com>
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=nvidia.com; s=n1;
        t=1584750624; bh=tkr3SY8rCu4xq/IQO7tlyHmC7XB4rR5Niz2bUzGJYL0=;
        h=X-PGP-Universal:From:To:CC:Subject:Date:Message-ID:X-Mailer:
         In-Reply-To:References:MIME-Version:X-NVConfidentiality:
         Content-Type:Content-Transfer-Encoding;
        b=
...
index 69def4a9df00..f777e1215e33 100644
--- a/lib/Kconfig.debug
+++ b/lib/Kconfig.debug
...
new file mode 100644
index 000000000000..d75e18f2ffd2
--- /dev/null
+++ b/lib/test_hmm.c
@@ -0,0 +1,1177 @@
...
+
+	/*
+	 * If everything is being invalidated, just return since the
+	 * mmget_not_zero() will protect the device page table from
+	 * being used if the file remains open after the process dies
+	 * (e.g., dup() or fork()).
+	 */
+	if (range->start =3D=3D 0 && range->end =3D=3D ULONG_MAX)
+		return true;
+
