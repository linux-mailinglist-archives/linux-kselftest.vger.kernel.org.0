...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 81A9A101BCC
	for <lists+linux-kselftest@lfdr.de>; Tue, 19 Nov 2019 09:17:19 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1727822AbfKSIRO (ORCPT <rfc822;lists+linux-kselftest@lfdr.de>);
        Tue, 19 Nov 2019 03:17:14 -0500
Received: from hqemgate15.nvidia.com ([216.228.121.64]:19128 "EHLO
        hqemgate15.nvidia.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1727736AbfKSIRL (ORCPT
        <rfc822;linux-kselftest@vger.kernel.org>);
        Tue, 19 Nov 2019 03:17:11 -0500
...
Received: from rnnvemgw01.nvidia.com (10.128.109.123) by HQMAIL101.nvidia.com
 ...
 Transport; Tue, 19 Nov 2019 08:17:06 +0000
...
+		undo_dev_pagemap(nr, nr_start, flags, pages);
 	...
 	return 1;
@@ -2025,6 +2149,20 @@ static int __record_subpages(struct page *page, unsi=
gned long addr,
 	return nr;
 }
=20
...
=20
 	if (unlikely(pte_val(pte) !=3D pte_val(*ptep))) {
@@ -2126,8 +2263,8 @@ static int gup_huge_pmd(pmd_t orig, pmd_t *pmdp, unsi=
gned long addr,
...
=20
 	if (unlikely(pmd_val(orig) !=3D pmd_val(*pmdp))) {
@@ -2160,8 +2297,8 @@ static int gup_huge_pud(pud_t orig, pud_t *pudp, unsi=
gned long addr,
...
=20
 	if (unlikely(pud_val(orig) !=3D pud_val(*pudp))) {
@@ -2189,8 +2326,8 @@ static int gup_huge_pgd(pgd_t orig, pgd_t *pgdp, unsi=
gned long addr,
...
t. It
  * is NOT intended for Case 2 (RDMA: long-term pins).
@@ -2552,11 +2697,12 @@ long pin_user_pages(unsigned long start, unsigned l=
ong nr_pages,
 		    unsigned int gup_flags, struct page **pages,
