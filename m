...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 1DA023D6CDB
	for <lists+linux-kselftest@lfdr.de>; Tue, 27 Jul 2021 05:35:28 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S234422AbhG0Cy6 (ORCPT <rfc822;lists+linux-kselftest@lfdr.de>);
        Mon, 26 Jul 2021 22:54:58 -0400
Received: from mga18.intel.com ([134.134.136.126]:58530 "EHLO mga18.intel.com"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S235052AbhG0Cy6 (ORCPT <rfc822;linux-kselftest@vger.kernel.org>);
        Mon, 26 Jul 2021 22:54:58 -0400
X-IronPort-AV: E=McAfee;i="6200,9189,10057"; a="199586977"
X-IronPort-AV: E=Sophos;i="5.84,272,1620716400"; 
   d="scan'208";a="199586977"
Received: from fmsmga003.fm.intel.com ([10.253.24.29])
  by orsmga106.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 26 Jul 2021 20:35:25 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.84,272,1620716400"; 
   d="scan'208";a="505307699"
Received: from fedora29.sh.intel.com ([10.239.182.87])
  by FMSMGA003.fm.intel.com with ESMTP; 26 Jul 2021 20:35:22 -0700
...
Subject: [RFC PATCH v1 1/2] selftests/xsave: test basic XSAVE architecture functionality
Date:   Tue, 27 Jul 2021 11:34:43 +0800
Message-Id: <5cfbc30dcc6e684a307ac4bb90e34affdfaa9d56.1627355565.git.pengfei.xu@intel.com>
...
The XSAVE feature set supports the saving and restoring of state
components such as FPU, which is used for process context switching.

In order to ensure that XSAVE feature works correctly, this case tests the
execution of xsave/xrstor in user space: show and tests the content change
for xsave; the contents of xrstor and xsave should same on x86 platforms.
This case is the basis for XSAVE feature testing.
...
index fb010a35d61a..4c0ddb8228e1 100644
--- a/tools/testing/selftests/Makefile
+++ b/tools/testing/selftests/Makefile
@@ -73,6 +73,7 @@ TARGETS += user
 TARGETS += vDSO
 TARGETS += vm
 TARGETS += x86
+TARGETS += xsave
...
new file mode 100644
index 000000000000..c555f9d289a3
--- /dev/null
