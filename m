...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 1D56811C769
	for <lists+linux-kselftest@lfdr.de>; Thu, 12 Dec 2019 09:21:14 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1728360AbfLLIU5 (ORCPT <rfc822;lists+linux-kselftest@lfdr.de>);
        Thu, 12 Dec 2019 03:20:57 -0500
Received: from hqnvemgate26.nvidia.com ([216.228.121.65]:3976 "EHLO
        hqnvemgate26.nvidia.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1728433AbfLLITe (ORCPT
        <rfc822;linux-kselftest@vger.kernel.org>);
        Thu, 12 Dec 2019 03:19:34 -0500
Received: from hqpgpgate101.nvidia.com (Not Verified[216.228.121.13]) by hqnvemgate26.nvidia.com (using TLS: TLSv1.2, DES-CBC3-SHA)
        id <B5df1f8040000>; Thu, 12 Dec 2019 00:19:16 -0800
...
Received: from blueforge.nvidia.com (Not Verified[10.110.48.28]) by hqnvemgw03.nvidia.com with Trustwave SEG (v7,5,8,10121)
        id <B5df1f808000b>; Thu, 12 Dec 2019 00:19:20 -0800
...
Subject: [PATCH v10 22/25] mm, tree-wide: rename put_user_page*() to unpin_user_page*()
Date:   Thu, 12 Dec 2019 00:19:14 -0800
Message-ID: <20191212081917.1264184-23-jhubbard@nvidia.com>
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=nvidia.com; s=n1;
        t=1576138756; bh=2nFtU7PuTfe8OisTaIZaDzvllVYwZrueYc8d9E5G9XM=;
        h=X-PGP-Universal:From:To:CC:Subject:Date:Message-ID:X-Mailer:
         In-Reply-To:References:MIME-Version:X-NVConfidentiality:
         Content-Transfer-Encoding:Content-Type;
        b=
...
--- a/fs/io_uring.c
+++ b/fs/io_uring.c
@@ -4400,7 +4400,7 @@ static int io_sqe_buffer_unregister(struct io_ring_ct=
x *ctx)
...
@@ -4545,7 +4545,7 @@ static int io_sqe_buffer_register(struct io_ring_ctx =
*ctx, void __user *arg,
