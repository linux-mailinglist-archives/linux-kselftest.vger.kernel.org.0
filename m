...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id A83C0749538
	for <lists+linux-kselftest@lfdr.de>; Thu,  6 Jul 2023 08:02:58 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S232917AbjGFGC5 (ORCPT <rfc822;lists+linux-kselftest@lfdr.de>);
        Thu, 6 Jul 2023 02:02:57 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:37272 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S233342AbjGFGCq (ORCPT
        <rfc822;linux-kselftest@vger.kernel.org>);
        Thu, 6 Jul 2023 02:02:46 -0400
Received: from madras.collabora.co.uk (madras.collabora.co.uk [IPv6:2a00:1098:0:82:1000:25:2eeb:e5ab])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 2CC0A1FD9;
        Wed,  5 Jul 2023 23:02:38 -0700 (PDT)
Received: from localhost.localdomain (unknown [119.155.52.241])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange X25519 server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        (Authenticated sender: usama.anjum)
        by madras.collabora.co.uk (Postfix) with ESMTPSA id EEEC7660585C;
        Thu,  6 Jul 2023 07:02:29 +0100 (BST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=collabora.com;
        s=mail; t=1688623356;
        bh=jMI9vwtKtgjXcmn+sLDRMQyXyJyUejdh1AwSpT0QGi8=;
        h=From:To:Cc:Subject:Date:In-Reply-To:References:From;
        b=
...
Subject: [PATCH v23 2/5] fs/proc/task_mmu: Implement IOCTL to get and optionally clear info about PTEs
Date:   Thu,  6 Jul 2023 11:01:44 +0500
Message-Id: <20230706060147.444375-3-usama.anjum@collabora.com>
...
index 507cd4e59d07..b3f72aae63a7 100644
...
+#include <linux/minmax.h>
 ...
 #include <asm/elf.h>
 #include <asm/tlb.h>
@@ -1765,11 +1766,587 @@ static int pagemap_release(struct inode *inode, struct file *file)
 	return 0;
 }
