...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 72449E5657
	for <lists+linux-kselftest@lfdr.de>; Sat, 26 Oct 2019 00:00:39 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1725897AbfJYWAi (ORCPT <rfc822;lists+linux-kselftest@lfdr.de>);
        Fri, 25 Oct 2019 18:00:38 -0400
Received: from mail-wr1-f54.google.com ([209.85.221.54]:35732 "EHLO
        mail-wr1-f54.google.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1725801AbfJYWAi (ORCPT
        <rfc822;linux-kselftest@vger.kernel.org>);
        Fri, 25 Oct 2019 18:00:38 -0400
Received: by mail-wr1-f54.google.com with SMTP id l10so3966986wrb.2
        for <linux-kselftest@vger.kernel.org>; Fri, 25 Oct 2019 15:00:33 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=linaro.org; s=google;
        h=from:date:to:message-id:subject:mime-version;
        bh=UvAt5XK3UKeLNOq1Xzjs7kfNpCgTWKSd1Gi4Kgu20C4=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20161025;
        h=x-gm-message-state:from:date:to:message-id:subject:mime-version;
        bh=UvAt5XK3UKeLNOq1Xzjs7kfNpCgTWKSd1Gi4Kgu20C4=;
        b=
X-Gm-Message-State: APjAAAVaW+Pz/NYnc9dX7+1lhpgsIQ0cLTpzXeaCiO4MjLK5gr2O746Y
        pTrDet7ZWdIUsXLYpCtHcHprMQ==
X-Google-Smtp-Source: APXvYqyPuKGZC4tyLjNbKyEkQErLIropS4j12NzAi+7kaFl5nzh2Cm5EmqsLkYfvxCz/3dKUuJV1EA==
X-Received: by 2002:adf:e34b:: with SMTP id n11mr4675532wrj.250.1572040832432;
        Fri, 25 Oct 2019 15:00:32 -0700 (PDT)
Received: from 172.17.0.4 (ci.linaro.org. [88.99.136.175])
        by smtp.gmail.com with ESMTPSA id b186sm2830180wmb.21.2019.10.25.15.00.31
        (version=TLS1 cipher=ECDHE-RSA-AES128-SHA bits=128/128);
        Fri, 25 Oct 2019 15:00:31 -0700 (PDT)
From:   ci_notify@linaro.org
X-Google-Original-From: linaro-infrastructure-errors@lists.linaro.org
Date:   Fri, 25 Oct 2019 22:00:31 +0000 (UTC)
To:     lkft-triage@lists.linaro.org, dan.rue@linaro.org,
        anders.roxell@linaro.org, naresh.kamboju@linaro.org,
        shuah@kernel.org, linux-kselftest@vger.kernel.org
Message-ID: <477644851.10571.1572040831731.JavaMail.javamailuser@localhost>
Subject: next-20191025 kselftest results
MIME-Version: 1.0
Content-Type: multipart/mixed; 
        boundary="----=_Part_10570_1870264583.1572040831103"
...
------=_Part_10570_1870264583.1572040831103
...
Test details: https://qa-reports.linaro.org/lkft/linux-next-oe/build/next-20191025

Regressions (compared to build next-20191024)
------------------------------------------------------------------------
No regressions                                                                                                          
                                                                                                                       
Fixes (compared to build next-20191024)                                                                   
------------------------------------------------------------------------                                               
No fixes

In total:
------------------------------------------------------------------------
Ran 2139 total tests in the following environments and test suites.
pass 1100
fail 867
xfail 0
skip 172
