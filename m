Return-Path: <linux-kselftest+bounces-48159-lists+linux-kselftest=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kselftest@lfdr.de
Delivered-To: lists+linux-kselftest@lfdr.de
Received: from sea.lore.kernel.org (sea.lore.kernel.org [172.234.253.10])
	by mail.lfdr.de (Postfix) with ESMTPS id 42B9ACF1C13
	for <lists+linux-kselftest@lfdr.de>; Mon, 05 Jan 2026 04:47:18 +0100 (CET)
Received: from smtp.subspace.kernel.org (conduit.subspace.kernel.org [100.90.174.1])
	by sea.lore.kernel.org (Postfix) with ESMTP id 771893025A4E
	for <lists+linux-kselftest@lfdr.de>; Mon,  5 Jan 2026 03:45:21 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id EAB99320CA3;
	Mon,  5 Jan 2026 03:45:20 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b="DDMJtgmJ"
X-Original-To: linux-kselftest@vger.kernel.org
Received: from us-smtp-delivery-124.mimecast.com (us-smtp-delivery-124.mimecast.com [170.10.133.124])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id DA70A3161B3
	for <linux-kselftest@vger.kernel.org>; Mon,  5 Jan 2026 03:45:15 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=170.10.133.124
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1767584720; cv=none; b=JVz0pswsV8KEnPV2P54XkqzIN/NIIoHcAEfDQEC/Sbdy7+xY9tbmRDRnOBu4DFEh4g9wGtxqFZh1kjKmU1pthcDJTbsd6ZntFLbuQ8/moD7X2i8c32C7Ui2d8FhiiMInuFig1UkIRprHMM8ED0Qprz0xK9NyXJ0Ii625OfsdN4o=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1767584720; c=relaxed/simple;
	bh=+/OYZOgxhZ4Vonl2p6hS8VGZ9hxJSoGqJTWBGWvmkEk=;
	h=From:To:Cc:Subject:Date:Message-ID:In-Reply-To:References:
	 MIME-Version; b=ESIJgbWFnsCNJzVjUzKW2tdWgDQQKNCIW0dSUfQK4RoIk1GODIVrJZnAbRjI4LXXohiX35GJSbAslDGIhFULBPDgXg6oNG11yGUbfOGSTGuF0BfEU2r5jhSuulnnTzp1vd0DntaoLDJpQXANhHxcEUdebLXhHbLPY4zruDmj/mA=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=quarantine dis=none) header.from=redhat.com; spf=pass smtp.mailfrom=redhat.com; dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b=DDMJtgmJ; arc=none smtp.client-ip=170.10.133.124
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=quarantine dis=none) header.from=redhat.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=redhat.com
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
	s=mimecast20190719; t=1767584713;
	h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
	 to:to:cc:cc:mime-version:mime-version:
	 content-transfer-encoding:content-transfer-encoding:
	 in-reply-to:in-reply-to:references:references;
	bh=yWfahjeY2G7v4HDZQCzbbduW3LNLjzUxuqDuQi2Ak9g=;
	b=DDMJtgmJSb6Kvn9EABdVH7dpFffp6k3ZgywmGQ6lWIqNtfWwpFxk/gtqkfPKQ+wkcdysr2
	9q/43xpnF9L9kVRVq+KBCNlEhcRxGTJY42i/Yj7Y6eWahPqaJKzbFSKWxhTGCcuZUHldZp
	qZeMTtI1Goc9FAQFxyz1CyrUcQqU3d4=
Received: from mx-prod-mc-01.mail-002.prod.us-west-2.aws.redhat.com
 (ec2-54-186-198-63.us-west-2.compute.amazonaws.com [54.186.198.63]) by
 relay.mimecast.com with ESMTP with STARTTLS (version=TLSv1.3,
 cipher=TLS_AES_256_GCM_SHA384) id us-mta-682-2XOrmO3vNUqKUkO0RQgikg-1; Sun,
 04 Jan 2026 22:45:12 -0500
X-MC-Unique: 2XOrmO3vNUqKUkO0RQgikg-1
X-Mimecast-MFC-AGG-ID: 2XOrmO3vNUqKUkO0RQgikg_1767584710
Received: from mx-prod-int-06.mail-002.prod.us-west-2.aws.redhat.com (mx-prod-int-06.mail-002.prod.us-west-2.aws.redhat.com [10.30.177.93])
	(using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
	 key-exchange X25519 server-signature RSA-PSS (2048 bits) server-digest SHA256)
	(No client certificate requested)
	by mx-prod-mc-01.mail-002.prod.us-west-2.aws.redhat.com (Postfix) with ESMTPS id AEB1A195DE48;
	Mon,  5 Jan 2026 03:45:10 +0000 (UTC)
Received: from xudu-thinkpadx1carbongen9.nay.csb (unknown [10.66.60.72])
	by mx-prod-int-06.mail-002.prod.us-west-2.aws.redhat.com (Postfix) with ESMTP id C77511800665;
	Mon,  5 Jan 2026 03:45:06 +0000 (UTC)
...
Subject: [PATCH net-next v3 4/8] selftest: tap: Refactor tap test to use tuntap_helpers
Date: Mon,  5 Jan 2026 11:44:39 +0800
Message-ID: <d461c1cd5895b14ce5cb53015eadfb79539d7c46.1767580224.git.xudu@redhat.com>
...
index 9ec1c9b50e77..6793e47d67a7 100644
...
@@ -26,167 +25,36 @@ static unsigned char param_hwaddr_dest[] = {
...
@@ -218,91 +86,6 @@ static int opentap(const char *devname)
 	return fd;
 }
...
-
 ...
 {
 	uint8_t *cur = buf;
@@ -316,9 +99,12 @@ size_t build_test_packet_valid_udp_gso(uint8_t *buf, size_t payload_len)
...
@@ -332,9 +118,12 @@ size_t build_test_packet_valid_udp_csum(uint8_t *buf, size_t payload_len)
...
@@ -351,10 +140,13 @@ size_t build_test_packet_crash_tap_invalid_eth_proto(uint8_t *buf,
 	vh->gso_size = ETH_DATA_LEN - sizeof(struct iphdr);
 	cur += sizeof(*vh);
