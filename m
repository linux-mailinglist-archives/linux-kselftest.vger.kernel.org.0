Return-Path: <linux-kselftest+bounces-45764-lists+linux-kselftest=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kselftest@lfdr.de
Delivered-To: lists+linux-kselftest@lfdr.de
Received: from dfw.mirrors.kernel.org (dfw.mirrors.kernel.org [142.0.200.124])
	by mail.lfdr.de (Postfix) with ESMTPS id 392B2C6522E
	for <lists+linux-kselftest@lfdr.de>; Mon, 17 Nov 2025 17:29:01 +0100 (CET)
Received: from smtp.subspace.kernel.org (relay.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-ECDSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by dfw.mirrors.kernel.org (Postfix) with ESMTPS id A362A4EA6DB
	for <lists+linux-kselftest@lfdr.de>; Mon, 17 Nov 2025 16:22:15 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 19E232D060C;
	Mon, 17 Nov 2025 16:21:40 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=linux.dev header.i=@linux.dev header.b="Ba9kzzNr"
X-Original-To: linux-kselftest@vger.kernel.org
Received: from out-182.mta1.migadu.com (out-182.mta1.migadu.com [95.215.58.182])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id E1BD12C3258
	for <linux-kselftest@vger.kernel.org>; Mon, 17 Nov 2025 16:21:37 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=95.215.58.182
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1763396499; cv=none; b=HkwPfQCicxmKsuJQBWy33ejOc3rg15RRmAPwJh7+noD2W6BDLE31+HRHVF0ZfAUA6dYdlTrCbHAqH+bh2qIsQi5/MpVLDVDD6LG3LLLbHxYKJCZ33ezSDrKIP5pH3XfbwNsgXZzBxrz7F9i7nToHmi3Xb+fYvemvlLhnNw1lHd0=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1763396499; c=relaxed/simple;
	bh=nad3ns0Tkp0dhKKMPYpPYv0thZFn54LvuIJxJRbUVaI=;
	h=From:To:Cc:Subject:Date:Message-ID:In-Reply-To:References:
	 MIME-Version; b=fvvF5OfT9Q0w3gdnPRnUhJYKVdwaCdh6PRG2FI9+1P7RRsRXHaEPLqvZaicXH3LuOV6OwBoNcVas+WWLBb2Oqq/Shqzki9u7aryxCjZWZp0pFAOeQwP94UA63U9QeLRdk5SHPxmSAMeJjg4XOGTY05xF7dRVXKAcI+kZCaXZXIM=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=linux.dev; spf=pass smtp.mailfrom=linux.dev; dkim=pass (1024-bit key) header.d=linux.dev header.i=@linux.dev header.b=Ba9kzzNr; arc=none smtp.client-ip=95.215.58.182
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=linux.dev; s=key1;
	...
	bh=NxpPmkG0oVW8SEPBdW6VjSMfikLz9cFnZHgyNykgu1c=;
	b=Ba9kzzNrTKffvdwBl6Y3Q9TalRbbJYjwXzh9gO0ohHhFeuonnS8uEA/YYCuJnUHCd8ZSmi
	YJWS8zWb2MpOwQWpZFsYS8VmIz3PDF+/3FM2mX6ICBe3LcebRDjGq8qocqJ4sWNGsei1VR
	9vHRzcGkpMaYwA8vOD8UgM19U/yd5Zw=
...
Subject: [PATCH bpf-next v10 4/8] bpf: Add BPF_F_CPU and BPF_F_ALL_CPUS flags support for percpu_hash and lru_percpu_hash maps
Date: Tue, 18 Nov 2025 00:20:29 +0800
Message-ID: <20251117162033.6296-5-leon.hwang@linux.dev>
...
@@ -2747,7 +2747,7 @@ int map_set_for_each_callback_args(struct bpf_verifier_env *env,
...
+int bpf_percpu_hash_copy(struct bpf_map *map, void *key, void *value, u64 flags);
 ...
 int bpf_percpu_hash_update(struct bpf_map *map, void *key, void *value,
 			   u64 flags);
@@ -3817,6 +3817,8 @@ static inline bool bpf_map_supports_cpu_flags(enum bpf_map_type map_type)
 {
 	switch (map_type) {
