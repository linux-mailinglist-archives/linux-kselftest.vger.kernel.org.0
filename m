...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 522129F7A1
	for <lists+linux-kselftest@lfdr.de>; Wed, 28 Aug 2019 03:00:45 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726111AbfH1BAo (ORCPT <rfc822;lists+linux-kselftest@lfdr.de>);
        Tue, 27 Aug 2019 21:00:44 -0400
Received: from mail-wm1-f67.google.com ([209.85.128.67]:39224 "EHLO
        mail-wm1-f67.google.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1726092AbfH1BAn (ORCPT
        <rfc822;linux-kselftest@vger.kernel.org>);
        Tue, 27 Aug 2019 21:00:43 -0400
Received: by mail-wm1-f67.google.com with SMTP id i63so944579wmg.4
        for <linux-kselftest@vger.kernel.org>; Tue, 27 Aug 2019 18:00:39 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=linaro.org; s=google;
        h=from:date:to:message-id:subject:mime-version;
        bh=wz2pWF4VXFKu3a3GLjhJrCi0Id1Eykx0G4Ba3cVP3wg=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20161025;
        h=x-gm-message-state:from:date:to:message-id:subject:mime-version;
        bh=wz2pWF4VXFKu3a3GLjhJrCi0Id1Eykx0G4Ba3cVP3wg=;
        b=
X-Gm-Message-State: APjAAAWtNi2bvflrEzKJd7vfFdwiJC+kJNY/gwF9TsP2BOhbvejBDdLh
        aU+CqLrMCe1HpGef8i+9aF/8hWHg0Bs=
X-Google-Smtp-Source: APXvYqwjCeC3iI6cpNZM+UyJAmq7VFZ68MIDxc0xbLMS2SybOpyx3HoyMCII2CcznwdzmVqdc219dw==
X-Received: by 2002:a1c:2582:: with SMTP id l124mr1236166wml.153.1566954038593;
        Tue, 27 Aug 2019 18:00:38 -0700 (PDT)
Received: from jenkins (ci.linaro.org. [88.99.136.175])
        by smtp.gmail.com with ESMTPSA id f23sm527926wmb.11.2019.08.27.18.00.37
        (version=TLS1 cipher=ECDHE-RSA-AES128-SHA bits=128/128);
        Tue, 27 Aug 2019 18:00:37 -0700 (PDT)
From:   ci_notify@linaro.org
X-Google-Original-From: linaro-infrastructure-errors@lists.linaro.org
Date:   Wed, 28 Aug 2019 01:00:36 +0000 (UTC)
To:     lkft-triage@lists.linaro.org, dan.rue@linaro.org,
        anders.roxell@linaro.org, naresh.kamboju@linaro.org,
        linux-kselftest@vger.kernel.org
Message-ID: <128786227.3036.1566954037685.JavaMail.javamailuser@localhost>
Subject: next-20190827 kselftest results
MIME-Version: 1.0
Content-Type: multipart/mixed; 
        boundary="----=_Part_3035_959337891.1566954036854"
...
------=_Part_3035_959337891.1566954036854
...
Test details: https://qa-reports.linaro.org/lkft/linux-next-oe/build/next-20190827

Regressions (compared to build next-20190826)
------------------------------------------------------------------------
i386:                                                                                                      
 kselftest:                                                                                         
...
Fixes (compared to build next-20190826)                                                                   
------------------------------------------------------------------------                                               
juno-r2 - arm64:                                                                                                      
 kselftest:                                                                                         
    * net_udpgso_bench.sh                                                                                                         
...
In total:
------------------------------------------------------------------------
Ran 1934 total tests in the following environments and test suites.
pass 1117
fail 669
xfail 0
skip 148
...
Test Suites
-----------
* boot-lkft-kselftests-master-593
* kselftest
* boot-lkft-kselftests-vsyscall-mode-native-master-593
* boot-lkft-kselftests-vsyscall-mode-none-master-593
* kselftest-vsyscall-mode-native
* kselftest-vsyscall-mode-none
...
dragonboard-410c:
* boot-lkft-kselftests-master-593/dragonboard-410c
