...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id E30546F100B
	for <lists+linux-kselftest@lfdr.de>; Fri, 28 Apr 2023 03:37:41 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S229984AbjD1Bhk (ORCPT <rfc822;lists+linux-kselftest@lfdr.de>);
        Thu, 27 Apr 2023 21:37:40 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:55974 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229818AbjD1Bhj (ORCPT
        <rfc822;linux-kselftest@vger.kernel.org>);
        Thu, 27 Apr 2023 21:37:39 -0400
Received: from mga17.intel.com (mga17.intel.com [192.55.52.151])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id DA87B273E;
        Thu, 27 Apr 2023 18:37:36 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
  t=1682645856; x=1714181856;
  h=date:from:to:cc:subject:message-id:references:
   mime-version:in-reply-to;
  bh=354QgtdLwfybzDquLVF3toiL35rBHK32x3DLiS8CR+E=;
  b=nQL7Mc6apfAgh7tlP4KwhoEYtxcgovcP0OthYo1yQz5G6AmGaypJkGST
   CS7OE2tzHbC9BFP1ZNtoGqjGxgFhnkzgb+eqNkFxmPpr/jj9pn9RH6omt
   NPF10yRLHJ35+I5jmVP25IfbvSisylbsceS5YLmdweCQPkfKp4eC3L6tP
   /R//hGm3y+/VFpWpYtByxJ2U7cmv/3PxWnDADhaGixdbifPEqvR8UOajx
   HVd3Ufwuu/OFXF6GTSKDzGs1oX418/iI+ng+MLyJ+i53vFyiUvSHIuAL6
   Oq/jY+0diDc6aBrF6wwu0gxNQwjX/1ykRgJTFquGmRnE/7bVcf6rhcvKY
   Q==;
X-IronPort-AV: E=McAfee;i="6600,9927,10693"; a="327947585"
X-IronPort-AV: E=Sophos;i="5.99,233,1677571200"; 
   d="scan'208";a="327947585"
Received: from orsmga003.jf.intel.com ([10.7.209.27])
  by fmsmga107.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 27 Apr 2023 18:37:36 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10693"; a="644926202"
X-IronPort-AV: E=Sophos;i="5.99,233,1677571200"; 
   d="scan'208";a="644926202"
Received: from lkp-server01.sh.intel.com (HELO b95e16499b55) ([10.239.97.150])
  by orsmga003.jf.intel.com with ESMTP; 27 Apr 2023 18:37:32 -0700
Received: from kbuild by b95e16499b55 with local (Exim 4.96)
        (envelope-from <lkp@intel.com>)
        id 1psD3D-0000Gv-33;
        Fri, 28 Apr 2023 01:37:31 +0000
Date:   Fri, 28 Apr 2023 09:37:00 +0800
...
Subject: Re: [PATCH tracing 1/3] tracing: support > 8 byte array filter
 predicates
Message-ID: <202304280925.9oX4NgJI-lkp@intel.com>
...
config: mips-randconfig-s053-20230427 (https://download.01.org/0day-ci/archive/20230428/202304280925.9oX4NgJI-lkp@intel.com/config)
...
reproduce:
        ...
        COMPILER_INSTALL_PATH=$HOME/0day COMPILER=gcc-12.1.0 make.cross C=1 CF='-fdiagnostic-prefix -D__CHECK_ENDIAN__' O=build_dir ARCH=mips SHELL=/bin/bash arch/mips/dec/ kernel/trace/

If you fix the issue, kindly add following tag where applicable
| Reported-by: kernel test robot <lkp@intel.com>
| Link: https://lore.kernel.org/oe-kbuild-all/202304280925.9oX4NgJI-lkp@intel.com/

sparse warnings: (new ones prefixed by >>)
>> kernel/trace/trace_events_filter.c:628:55: sparse: sparse: non size-preserving integer to pointer cast
   kernel/trace/trace_events_filter.c:900:26: sparse: sparse: non size-preserving integer to pointer cast
   kernel/trace/trace_events_filter.c:1146:20: sparse: sparse: incorrect type in return expression (different address spaces) @@     expected struct event_filter * @@     got struct event_filter [noderef] __rcu *filter @@
   kernel/trace/trace_events_filter.c:1146:20: sparse:     expected struct event_filter *
   kernel/trace/trace_events_filter.c:1146:20: sparse:     got struct event_filter [noderef] __rcu *filter
   kernel/trace/trace_events_filter.c:1216:34: sparse: sparse: incorrect type in argument 1 (different address spaces) @@     expected struct event_filter *filter @@     got struct event_filter [noderef] __rcu *filter @@
   kernel/trace/trace_events_filter.c:1216:34: sparse:     expected struct event_filter *filter
   kernel/trace/trace_events_filter.c:1216:34: sparse:     got struct event_filter [noderef] __rcu *filter
   kernel/trace/trace_events_filter.c:1233:27: sparse: sparse: incorrect type in argument 1 (different address spaces) @@     expected struct event_filter *filter @@     got struct event_filter [noderef] __rcu *filter @@
   kernel/trace/trace_events_filter.c:1233:27: sparse:     expected struct event_filter *filter
   kernel/trace/trace_events_filter.c:1233:27: sparse:     got struct event_filter [noderef] __rcu *filter
>> kernel/trace/trace_events_filter.c:1682:34: sparse: sparse: non size-preserving pointer to integer cast
   kernel/trace/trace_events_filter.c:1146:20: sparse: sparse: incorrect type in return expression (different address spaces) @@     expected struct event_filter * @@     got struct event_filter [noderef] __rcu *filter @@
   kernel/trace/trace_events_filter.c:1146:20: sparse:     expected struct event_filter *
   kernel/trace/trace_events_filter.c:1146:20: sparse:     got struct event_filter [noderef] __rcu *filter
   kernel/trace/trace_events_filter.c:1146:20: sparse: sparse: incorrect type in return expression (different address spaces) @@     expected struct event_filter * @@     got struct event_filter [noderef] __rcu *filter @@
