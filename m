...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 0E474598D4F
	for <lists+linux-kselftest@lfdr.de>; Thu, 18 Aug 2022 22:05:17 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1345674AbiHRUAv (ORCPT <rfc822;lists+linux-kselftest@lfdr.de>);
        Thu, 18 Aug 2022 16:00:51 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:54634 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1344870AbiHRUAW (ORCPT
        <rfc822;linux-kselftest@vger.kernel.org>);
        Thu, 18 Aug 2022 16:00:22 -0400
Received: from mail-ej1-x62a.google.com (mail-ej1-x62a.google.com [IPv6:2a00:1450:4864:20::62a])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 187CCD11D4;
        Thu, 18 Aug 2022 13:00:20 -0700 (PDT)
Received: by mail-ej1-x62a.google.com with SMTP id w19so5174885ejc.7;
        Thu, 18 Aug 2022 13:00:19 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=20210112;
        h=content-transfer-encoding:mime-version:references:in-reply-to
         :message-id:date:subject:cc:to:from:from:to:cc;
        bh=Nf9BA+Y8PcTFBc7/UFSdzG95FPPUF2z5i+juXoSi/so=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=Nf9BA+Y8PcTFBc7/UFSdzG95FPPUF2z5i+juXoSi/so=;
        b=
X-Gm-Message-State: ACgBeo1HMWM8pS0+5hEwUSxAlQR2U+VWqzINl47mkSQvepfMtuGSqTTQ
        zq0xsc4pPPrDUDCP9q9WmfY=
X-Google-Smtp-Source: AA6agR7EZf7u081lQL2aMSPy7NTZSYebTTxVaxqNA5XnMdX1vcS1OgklORGMO57SIODM3ihhYPTHYg==
X-Received: by 2002:a17:907:75ce:b0:73b:dab0:8937 with SMTP id jl14-20020a17090775ce00b0073bdab08937mr2292310ejc.568.1660852818402;
        Thu, 18 Aug 2022 13:00:18 -0700 (PDT)
Received: from localhost.localdomain ([2a04:241e:502:a080:17c8:ba1c:b6f3:3fe0])
        by smtp.gmail.com with ESMTPSA id fw30-20020a170907501e00b00722e4bab163sm1215087ejc.200.2022.08.18.13.00.16
...
Subject: [PATCH v7 01/26] tcp: authopt: Initial support and key management
Date:   Thu, 18 Aug 2022 22:59:35 +0300
Message-Id: <3b1a1be61e9300af242280313c93b901da9f57a6.1660852705.git.cdleonard@gmail.com>
...
index 970e9a2cca4a..1e9eaf805e4c 100644
--- a/net/ipv4/tcp.c
+++ b/net/ipv4/tcp.c
@@ -270,10 +270,11 @@
...
@@ -3706,10 +3707,18 @@ static int do_tcp_setsockopt(struct sock *sk, int level, int optname,
 #ifdef CONFIG_TCP_MD5SIG
 	case TCP_MD5SIG:
 	case TCP_MD5SIG_EXT:
...
+		break;
 	...
 	case TCP_USER_TIMEOUT:
 		 ...
 		 */
@@ -4357,10 +4366,33 @@ static int do_tcp_getsockopt(struct sock *sk, int level,
...
index 0c83780dc9bf..e8b2ab088828 100644
