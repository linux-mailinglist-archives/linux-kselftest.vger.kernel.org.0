...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 6D1A018FB01
	for <lists+linux-kselftest@lfdr.de>; Mon, 23 Mar 2020 18:11:17 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1727772AbgCWRLI (ORCPT <rfc822;lists+linux-kselftest@lfdr.de>);
        Mon, 23 Mar 2020 13:11:08 -0400
Received: from userp2130.oracle.com ([156.151.31.86]:43668 "EHLO
        userp2130.oracle.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1727720AbgCWRLI (ORCPT
        <rfc822;linux-kselftest@vger.kernel.org>);
        Mon, 23 Mar 2020 13:11:08 -0400
Received: from pps.filterd (userp2130.oracle.com [127.0.0.1])
        by userp2130.oracle.com (8.16.0.42/8.16.0.42) with SMTP id 02NH9Iv6000739;
        Mon, 23 Mar 2020 17:11:01 GMT
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=oracle.com; h=from : to : cc :
 subject : date : message-id : in-reply-to : references; s=corp-2020-01-29;
 bh=U2If3Mfn6rZGFJRiF7Rw7+MYnUgHcrCVJynk/E+aXuQ=;
 b= FQ== 
Received: from userp3020.oracle.com (userp3020.oracle.com [156.151.31.79])
        by userp2130.oracle.com with ESMTP id 2ywabqyw86-1
        (version=TLSv1.2 cipher=ECDHE-RSA-AES256-GCM-SHA384 bits=256 verify=OK);
        Mon, 23 Mar 2020 17:11:01 +0000
Received: from pps.filterd (userp3020.oracle.com [127.0.0.1])
        by userp3020.oracle.com (8.16.0.42/8.16.0.42) with SMTP id 02NGvLpe028450;
        Mon, 23 Mar 2020 17:11:01 GMT
Received: from userv0122.oracle.com (userv0122.oracle.com [156.151.31.75])
        by userp3020.oracle.com with ESMTP id 2yxw6jxhh1-1
        (version=TLSv1.2 cipher=ECDHE-RSA-AES256-GCM-SHA384 bits=256 verify=OK);
        Mon, 23 Mar 2020 17:11:01 +0000
Received: from abhmp0001.oracle.com (abhmp0001.oracle.com [141.146.116.7])
        by userv0122.oracle.com (8.14.4/8.14.4) with ESMTP id 02NHB0GS009802;
        Mon, 23 Mar 2020 17:11:00 GMT
Received: from localhost.uk.oracle.com (/10.175.192.214)
        by default (Oracle Beehive Gateway v4.0)
        with ESMTP ; Mon, 23 Mar 2020 10:10:59 -0700
...
Subject: [PATCH v2 kunit-next 1/2] kunit: generalize kunit_resource API beyond allocated resources
Date:   Mon, 23 Mar 2020 17:10:42 +0000
Message-Id: <1584983443-27456-2-git-send-email-alan.maguire@oracle.com>
...
---
 ...
 lib/kunit/test.c          | 189 ++++++++++++++++++++++++++++++----------------
 4 files changed, 263 insertions(+), 124 deletions(-)

diff --git a/include/kunit/test.h b/include/kunit/test.h
index 2dfb550..4608ff0 100644
...
@@ -251,6 +255,34 @@ struct kunit_resource *kunit_alloc_and_get_resource(struct kunit *test,
 						    void *context);
...
@@ -262,7 +294,7 @@ struct kunit_resource *kunit_alloc_and_get_resource(struct kunit *test,
...
+ * Note: KUnit needs to allocate memory for a kunit_resource object. You must
  ...
  * resource.
  */
@@ -274,54 +306,72 @@ static inline void *kunit_alloc_resource(struct kunit *test,
 {
 	struct kunit_resource *res;
...
@@ -323,11 +324,69 @@ int kunit_run_tests(struct kunit_suite *suite)
 }
...
+						    void *data)
 {
 	struct kunit_resource *res;
 	int ret;
@@ -336,77 +395,67 @@ struct kunit_resource *kunit_alloc_and_get_resource(struct kunit *test,
 	if (!res)
 		return NULL;
...
+EXPORT_SYMBOL_GPL(kunit_destroy_resource);
 ...
 struct kunit_kmalloc_params {
 	size_t size;
@@ -417,8 +466,8 @@ static int kunit_kmalloc_init(struct kunit_resource *res, void *context)
 {
 	struct kunit_kmalloc_params *params = context;
...
+	if (!res->data)
 	...
 	return 0;
@@ -426,7 +475,7 @@ static int kunit_kmalloc_init(struct kunit_resource *res, void *context)
...
+	kfree(res->data);
 ...
 void *kunit_kmalloc(struct kunit *test, size_t size, gfp_t gfp)
@@ -446,20 +495,25 @@ void *kunit_kmalloc(struct kunit *test, size_t size, gfp_t gfp)
...
@@ -476,13 +530,16 @@ void kunit_cleanup(struct kunit *test)
 			spin_unlock(&test->lock);
 			break;
 		}
