...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id D68DA47CED
	for <lists+linux-kselftest@lfdr.de>; Mon, 17 Jun 2019 10:28:46 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1727735AbfFQI05 (ORCPT <rfc822;lists+linux-kselftest@lfdr.de>);
        Mon, 17 Jun 2019 04:26:57 -0400
Received: from mail-qk1-f202.google.com ([209.85.222.202]:32856 "EHLO
        mail-qk1-f202.google.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1727726AbfFQI05 (ORCPT
        <rfc822;linux-kselftest@vger.kernel.org>);
        Mon, 17 Jun 2019 04:26:57 -0400
Received: by mail-qk1-f202.google.com with SMTP id t196so8547083qke.0
        for <linux-kselftest@vger.kernel.org>; Mon, 17 Jun 2019 01:26:56 -0700 (PDT)
...
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=cUnWzVAEdqo7bGTNoMyzrIXrLOc4T43iDGYg6P6lpY4=;
        b=
X-Gm-Message-State: APjAAAW0+y0EAZ7mOhN/ARea/9GtGNEj2Nnns4KhTXKi0nj0iKsS9oQ5
        ISXccomwHBpG/iXJNrnyEotKooqlPZWlqWPCUKWiSQ==
...
Subject: [PATCH v5 04/18] kunit: test: add kunit_stream a std::stream like logger
...
Changes Since Last Revision:
 - Renamed kunit_new_stream() to alloc_kunit_stream() as suggested by
   Stephen Boyd.
 - Removed the ability to set log level after allocating a stream, as
   suggested by Stephen Boyd.
 - Removed locking, as it is now unnecessary with the previous change.
...
index 27bd95b6b5523..83fb7ace1b320 100644
...
index 53838f5394303..9404e4d34fa3f 100644
--- a/kunit/test.c
+++ b/kunit/test.c
@@ -139,6 +139,12 @@ static void kunit_print_test_case_ok_not_ok(struct kunit_case *test_case,
 			      test_case->name);
 }
