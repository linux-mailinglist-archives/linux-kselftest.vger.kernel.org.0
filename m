Return-Path: <linux-kselftest+bounces-30770-lists+linux-kselftest=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kselftest@lfdr.de
Delivered-To: lists+linux-kselftest@lfdr.de
Received: from ny.mirrors.kernel.org (ny.mirrors.kernel.org [IPv6:2604:1380:45d1:ec00::1])
	by mail.lfdr.de (Postfix) with ESMTPS id A7F48A88E3C
	for <lists+linux-kselftest@lfdr.de>; Mon, 14 Apr 2025 23:50:41 +0200 (CEST)
Received: from smtp.subspace.kernel.org (relay.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-ECDSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by ny.mirrors.kernel.org (Postfix) with ESMTPS id 999DE173430
	for <lists+linux-kselftest@lfdr.de>; Mon, 14 Apr 2025 21:50:41 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id E6254204F83;
	Mon, 14 Apr 2025 21:48:50 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=google.com header.i=@google.com header.b="wQfpeWu5"
X-Original-To: linux-kselftest@vger.kernel.org
Received: from mail-pf1-f202.google.com (mail-pf1-f202.google.com [209.85.210.202])
	(using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 5F0631FF7A5
	for <linux-kselftest@vger.kernel.org>; Mon, 14 Apr 2025 21:48:48 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=209.85.210.202
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1744667330; cv=none; b=sDlkguit6qwG2x/AuZJjjU3ThQoTYnpvKm2kGfZPoP27QAW/jxmpHm43EW0CyqNtKczOAMzzFqpC9Hkkw2WynHcBqEcYNB5LxpUHBq9JL296k6YXYaYI4v0JcPY7JcsQL1mUoS5PoeDPN8OoYr38uCSULmVTXpfLmXpH3hbNahM=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1744667330; c=relaxed/simple;
	bh=pZtF5H1wNCJsjaZQsRxNktH3O+naXT+TsUJVvxobvTc=;
	h=Date:In-Reply-To:Mime-Version:References:Message-ID:Subject:From:
	 To:Cc:Content-Type; b=eR/K3a+o9qCvP1Br5YHDyRnnbgh4pKwilbfecNB7jPWMGHLq7CQgDKj6xfvqDcmRseLY92OJBS+Ssxn4NLwvrAoIv/TEkdm3ZIJ2zKbaAHxgH7OT/g5JFVhwfIr6yspVZrBzeAXip/rLm9jdXrUpRIr9l5gQDn8VEoju/bVFXH4=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=reject dis=none) header.from=google.com; spf=pass smtp.mailfrom=flex--sagis.bounces.google.com; dkim=pass (2048-bit key) header.d=google.com header.i=@google.com header.b=wQfpeWu5; arc=none smtp.client-ip=209.85.210.202
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=reject dis=none) header.from=google.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=flex--sagis.bounces.google.com
Received: by mail-pf1-f202.google.com with SMTP id d2e1a72fcca58-736cb72efd5so4155059b3a.3
        for <linux-kselftest@vger.kernel.org>; Mon, 14 Apr 2025 14:48:48 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=google.com; s=20230601; t=1744667327; x=1745272127; darn=vger.kernel.org;
        h=content-transfer-encoding:cc:to:from:subject:message-id:references
         :mime-version:in-reply-to:date:from:to:cc:subject:date:message-id
         :reply-to;
        bh=fZvzTYq6fjqmNGSiHCbx+jGCy6I6U5x2erHJ9/ZEQO4=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20230601; t=1744667327; x=1745272127;
        h=content-transfer-encoding:cc:to:from:subject:message-id:references
         :mime-version:in-reply-to:date:x-gm-message-state:from:to:cc:subject
         :date:message-id:reply-to;
        bh=fZvzTYq6fjqmNGSiHCbx+jGCy6I6U5x2erHJ9/ZEQO4=;
        b=
X-Gm-Message-State: AOJu0Yzz4SMnfkwMPk6cVqVIgn7WhQr3WSBsddNzpKQf26gben/TOf1+
	65r6RN0HwHufN/CqI+JqUmF4SOERuyAI1V5vYeAeYTC8ZVCfwyIAKZFfSQ6SNFtlpkbAvAC4tAv
	QHLm0oRGZdkiPULdTXZMjzR/MrDlseOrCaUqHZU6X8VIj52gJfPawWDZyacCaSmXdR8QNn8GOlo
	cPlOsc8tl+CbtVnA1ILdihvduA7g9GtUyDMzEoOuc=
X-Google-Smtp-Source: AGHT+IE3OlWCPaWJwitXCVegvYCne1Bbn5/4QxpLRy7aLYLHdirm84bNhrRO5ktrRGxVKV8hdpR+N6Z+dA==
X-Received: from pfpk18.prod.google.com ([2002:aa7:9d12:0:b0:730:4672:64ac])
 (user=sagis job=prod-delivery.src-stubby-dispatcher) by 2002:a05:6a00:1388:b0:739:56c2:b661
 with SMTP id d2e1a72fcca58-73bd1203098mr19332433b3a.12.1744667327378; Mon, 14
 Apr 2025 14:48:47 -0700 (PDT)
Date: Mon, 14 Apr 2025 14:47:35 -0700
...
Message-ID: <20250414214801.2693294-7-sagis@google.com>
Subject: [PATCH v6 06/30] KVM: selftests: Add helper functions to create TDX VMs
...
index f62b0a5aba35..8e7a12d74745 100644
--- a/tools/testing/selftests/kvm/Makefile.kvm
+++ b/tools/testing/selftests/kvm/Makefile.kvm
@@ -28,6 +28,8 @@ LIBKVM_x86 +=3D lib/x86/sev.c
...
index 74ecfd8d7ae0..813ba634dc49 100644
...
=20
@@ -985,6 +986,9 @@ unsigned long vm_compute_max_gfn(struct kvm_vm *vm);
...
pages)
 {
@@ -1150,6 +1154,8 @@ static inline int __vm_disable_nx_huge_pages(struct k=
vm_vm *vm)
  */
...
index 40dd63f2bd05..f8cf49794eed 100644
--- a/tools/testing/selftests/kvm/lib/kvm_util.c
+++ b/tools/testing/selftests/kvm/lib/kvm_util.c
@@ -373,9 +373,9 @@ struct kvm_vm *____vm_create(struct vm_shape shape)
 	return vm;
 }
=20
...
index 1c42af328f19..9b2c236e723a 100644
...
@@ -697,16 +697,19 @@ struct kvm_vcpu *vm_arch_vcpu_add(struct kvm_vm *vm, =
uint32_t vcpu_id)
=20
