Return-Path: <linux-kselftest+bounces-39166-lists+linux-kselftest=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kselftest@lfdr.de
Delivered-To: lists+linux-kselftest@lfdr.de
Received: from am.mirrors.kernel.org (am.mirrors.kernel.org [147.75.80.249])
	by mail.lfdr.de (Postfix) with ESMTPS id 780E6B291E9
	for <lists+linux-kselftest@lfdr.de>; Sun, 17 Aug 2025 09:02:16 +0200 (CEST)
Received: from smtp.subspace.kernel.org (relay.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-ECDSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by am.mirrors.kernel.org (Postfix) with ESMTPS id 9DE011895A5E
	for <lists+linux-kselftest@lfdr.de>; Sun, 17 Aug 2025 07:01:56 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 452C219F135;
	Sun, 17 Aug 2025 07:01:31 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=gmail.com header.i=@gmail.com header.b="d1reR8PY"
X-Original-To: linux-kselftest@vger.kernel.org
Received: from mail-pl1-f170.google.com (mail-pl1-f170.google.com [209.85.214.170])
	(using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id EDC1C3176F3;
	Sun, 17 Aug 2025 07:01:26 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=209.85.214.170
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1755414091; cv=none; b=H41s/mMla6ZSmlhqctAM+Uy1NqOH9RGHtajz3JC0iZY6GELs3LYhIeosU1HgT2rIF2ediH1evKjIpMXbkmxZx9kkSm0FoK3y2GfFb0WCA56LsoY/+2f9hPV5d+2Xk5+7OowJwLKZidlC5Va5Vv3cWEZ26BsO2ud6IJYpDTfPFL8=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1755414091; c=relaxed/simple;
	bh=My8X3bIOhbFGq+kUAsBYtIeQnfjBjrda/bQD2jVpZA0=;
	h=From:To:Cc:Subject:Date:Message-Id:MIME-Version; b=gqecqbKjmcdb8jyroyVaMPnUUrKSR6v1I7CrkylQ9RYFz4RjXnryRhjDTK0BtLWlWEl4GQqT2wEFYLwbHRcHqVehV0YRGymkJMMjU43W1Tw8KUxf1P2IZ5f687+Z0umOOtcM/98vWHO2ZLy1PU3ha8oBBQGY6d0LPAFcU82Tz5Q=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=gmail.com; spf=pass smtp.mailfrom=gmail.com; dkim=pass (2048-bit key) header.d=gmail.com header.i=@gmail.com header.b=d1reR8PY; arc=none smtp.client-ip=209.85.214.170
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=gmail.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=gmail.com
Received: by mail-pl1-f170.google.com with SMTP id d9443c01a7336-24457f53d2eso36949795ad.0;
        Sun, 17 Aug 2025 00:01:26 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=20230601; t=1755414086; x=1756018886; darn=vger.kernel.org;
        h=content-transfer-encoding:mime-version:message-id:date:subject:cc
         :to:from:from:to:cc:subject:date:message-id:reply-to;
        bh=kPqYYP8QnQxSkQsqLSKEOfT9oupGxbeTlGAPpzp/N0w=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20230601; t=1755414086; x=1756018886;
        h=content-transfer-encoding:mime-version:message-id:date:subject:cc
         :to:from:x-gm-message-state:from:to:cc:subject:date:message-id
         :reply-to;
        bh=kPqYYP8QnQxSkQsqLSKEOfT9oupGxbeTlGAPpzp/N0w=;
        b=
X-Forwarded-Encrypted: i=1; AJvYcCVVxhslU0yD5EdiIqSvIu8K/yw/D+Yidt6lz9ahMJIj7lWSzVVTl2PmVBIa8R5qhIstC3K8N2L8iPluR/g=@vger.kernel.org, AJvYcCVkdxtvj5U3Px3yp/aGVzD7OCME/jsm/GXn6YcHgLkeJ/MSP1JGlt/wYbi5jHHuSkjj8E3GKNDS/rZv6LsdohXx@vger.kernel.org
X-Gm-Message-State: AOJu0Yya3S7ynvf8Om0ZTolFlrpCei08wobdLh0jaGoBLAhc3ZCsSxNc
	iFpeL+UkrYKCDgY5sn4CznGS+I/finC3iJXaxFvRcNgaMfmLCWLAEWA=
X-Gm-Gg: 
X-Google-Smtp-Source: AGHT+IHhUUk+Qd0QZWA8O5iXl/XXiMNCayWUVKAf0bOkD89H8VTfZal5RYqOK5BbzDbrelrAu9+Y3A==
X-Received: by 2002:a17:903:298b:b0:234:b123:b4ff with SMTP id d9443c01a7336-2446d73cb89mr90321525ad.21.1755414085338;
        Sun, 17 Aug 2025 00:01:25 -0700 (PDT)
Received: from debian.ujwal.com ([223.185.135.79])
        by smtp.gmail.com with ESMTPSA id d9443c01a7336-2446d5636bfsm49052245ad.144.2025.08.17.00.01.20
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Sun, 17 Aug 2025 00:01:24 -0700 (PDT)
...
Subject: [PATCH v7 1/1] selftests/mm/uffd: Refactor non-composite global vars into struct
Date: Sun, 17 Aug 2025 12:22:11 +0530
Message-Id: <20250817065211.855-1-ujwal.kundur@gmail.com>
...
+}
 ...
 {
@@ -40,15 +52,16 @@ static int uffd_mem_fd_create(off_t mem_size, bool hugetlb)
 	return mem_fd;
 }
...
+static int anon_allocate_area(uffd_global_test_opts_t *gopts, void **alloc_area,
+			      bool __unused is_src)
 {
...
+	*alloc_area = mmap(NULL, gopts->nr_pages * gopts->page_size, PROT_READ | PROT_WRITE,
 	...
 	if (*alloc_area == MAP_FAILED) {
 		*alloc_area = NULL;
@@ -57,32 +70,32 @@ static int anon_allocate_area(void **alloc_area, bool __unused is_src)
 	return 0;
 }
...
+			   (gopts->map_shared ? MAP_SHARED : MAP_PRIVATE) |
 			   ...
 			   mem_fd, offset);
 	if (*alloc_area == MAP_FAILED) {
@@ -90,7 +103,7 @@ static int hugetlb_allocate_area(void **alloc_area, bool is_src)
 		return -errno;
 	}
...
@@ -98,9 +111,9 @@ static int hugetlb_allocate_area(void **alloc_area, bool is_src)
 	}
...
@@ -109,24 +122,25 @@ static int hugetlb_allocate_area(void **alloc_area, bool is_src)
 	return 0;
 }
...
+				  size_t __unused len, unsigned long offset)
 {
-	if (!map_shared)
+	if (!gopts->map_shared)
 		return;
...
@@ -160,22 +174,24 @@ static int shmem_allocate_area(void **alloc_area, bool is_src)
...
+	if (!check_huge_shmem(gopts->area_dst_alias, expect_nr_hpages,
 		...
 		err("Did not find expected %d number of hugepages",
 		    expect_nr_hpages);
@@ -235,18 +251,18 @@ void uffd_stats_report(struct uffd_args *args, int n_cpus)
 	printf("\n");
 }
...
@@ -256,59 +272,63 @@ int userfaultfd_open(uint64_t *features)
 	return 0;
 }
...
@@ -316,26 +336,26 @@ int uffd_test_ctx_init(uint64_t features, const char **errmsg)
 	}
...
@@ -343,7 +363,7 @@ int uffd_test_ctx_init(uint64_t features, const char **errmsg)
...
+		*(area_count(gopts->area_src, nr, gopts) + 1) = 1;
 	...
 	/*
@@ -364,13 +384,13 @@ int uffd_test_ctx_init(uint64_t features, const char **errmsg)
...
+		if (pipe2(&gopts->pipefd[cpu * 2], O_CLOEXEC | O_NONBLOCK))
 	...
 	return 0;
@@ -417,9 +437,9 @@ static void continue_range(int ufd, __u64 start, __u64 len, bool wp)
...
+	int ret = read(gopts->uffd, msg, sizeof(*msg));
 	...
 	if (ret != sizeof(*msg)) {
 		if (ret < 0) {
@@ -434,7 +454,8 @@ int uffd_read_msg(struct uffd_msg *msg)
 	return 0;
 }
...
@@ -443,7 +464,7 @@ void uffd_handle_page_fault(struct uffd_msg *msg, struct uffd_args *args)
...
+		wp_range(gopts->uffd, msg->arg.pagefault.address, gopts->page_size, false);
 		...
 		uint8_t *area;
@@ -461,12 +482,12 @@ void uffd_handle_page_fault(struct uffd_msg *msg, struct uffd_args *args)
 		 * (UFFD-registered).
 		 */
...
@@ -494,10 +515,10 @@ void uffd_handle_page_fault(struct uffd_msg *msg, struct uffd_args *args)
...
@@ -505,6 +526,7 @@ void uffd_handle_page_fault(struct uffd_msg *msg, struct uffd_args *args)
...
+	uffd_global_test_opts_t *gopts = args->gopts;
 	...
 	struct uffd_msg msg;
@@ -515,12 +537,12 @@ void *uffd_poll_thread(void *arg)
...
+	gopts->ready_for_fork = true;
 	...
 	for (;;) {
 		ret = poll(pollfd, 2, -1);
@@ -538,30 +560,30 @@ void *uffd_poll_thread(void *arg)
 		}
...
@@ -569,17 +591,18 @@ void *uffd_poll_thread(void *arg)
 	return NULL;
 }
...
+			(int64_t)uffdio_copy->copy);
 		...
 		err("UFFDIO_COPY retry unexpected: %"PRId64,
 		    (int64_t)uffdio_copy->copy);
@@ -598,60 +621,60 @@ static void wake_range(int ufd, unsigned long addr, unsigned long len)
 			addr), exit(1);
 }
...
index 2e7066d69103..37d3ca55905f 100644
...
index 24aac0ae96c6..9b216e842bbb 100644
...
index ee9b407e893e..101eaca2662e 100644
...
+		value = pagemap_get_entry(fd, gopts->area_dst);
 		 ...
 		 *
@@ -361,70 +335,71 @@ static int pagemap_test_fork(int uffd, bool with_event, bool test_pin)
 	return result;
 }
 
-static void uffd_wp_unpopulated_test(uffd_test_args_t __unused *args)
+static void uffd_wp_unpopulated_test(uffd_global_test_opts_t *gopts,
+				     uffd_test_args_t __unused *args)
 {
 	uint64_t value;
 	int pagemap_fd;
...
+	if (pagemap_test_fork(gopts, with_event, false)) {
 		...
 		goto out;
@@ -442,79 +417,80 @@ static void uffd_wp_fork_test_common(uffd_test_args_t *args,
...
@@ -527,49 +503,50 @@ static void uffd_wp_fork_pin_test_common(uffd_test_args_t __unused *args,
...
@@ -577,7 +554,7 @@ static void uffd_minor_test_common(bool test_collapse, bool test_wp)
 	 */
...
+	if (uffd_register(gopts->uffd, gopts->area_dst_alias, gopts->nr_pages * gopts->page_size,
 			  ...
 			  false, test_wp, true))
 		err("register failure");
@@ -586,9 +563,9 @@ static void uffd_minor_test_common(bool test_collapse, bool test_wp)
...
@@ -600,50 +577,51 @@ static void uffd_minor_test_common(bool test_collapse, bool test_wp)
...
+void uffd_minor_test(uffd_global_test_opts_t *gopts, uffd_test_args_t __unused *args)
 {
...
+void uffd_minor_wp_test(uffd_global_test_opts_t *gopts, uffd_test_args_t __unused *args)
 {
...
+void uffd_minor_collapse_test(uffd_global_test_opts_t *gopts, uffd_test_args_t __unused *args)
 {
...
@@ -678,7 +656,7 @@ static void sighndl(int sig, siginfo_t __unused *siginfo, void __unused *ptr)
...
+static int faulting_process(uffd_global_test_opts_t *gopts, int signal_test, bool wp)
 {
 	unsigned long nr, i;
 	unsigned long long count;
@@ -687,7 +665,7 @@ static int faulting_process(int signal_test, bool wp)
...
+	split_nr_pages = (gopts->nr_pages + 1) / 2;
 	...
 	if (signal_test) {
 		sigbuf = &jbuf;
@@ -701,7 +679,7 @@ static int faulting_process(int signal_test, bool wp)
...
@@ -713,15 +691,15 @@ static int faulting_process(int signal_test, bool wp)
 					if (steps == 1) {
...
+							 gopts->page_size, false);
 					...
 					signalled++;
@@ -730,51 +708,53 @@ static int faulting_process(int signal_test, bool wp)
 			}
 		}
...
+static void uffd_sigbus_test_common(uffd_global_test_opts_t *gopts, bool wp)
 {
 	...
 	pthread_t uffd_mon;
@@ -782,25 +762,26 @@ static void uffd_sigbus_test_common(bool wp)
 	int err;
 	char c;
 	struct uffd_args args = { 0 };
+	args.gopts = gopts;
...
+	while (!gopts->ready_for_fork)
 	...
 	pid = fork();
@@ -808,12 +789,12 @@ static void uffd_sigbus_test_common(bool wp)
 		err("fork");
...
+	if (write(gopts->pipefd[1], &c, sizeof(c)) != sizeof(c))
 	...
 	if (pthread_join(uffd_mon, (void **)&userfaults))
 		err("pthread_join()");
@@ -824,28 +805,29 @@ static void uffd_sigbus_test_common(bool wp)
 		uffd_test_pass();
 }
 
-static void uffd_sigbus_test(uffd_test_args_t __unused *args)
+static void uffd_sigbus_test(uffd_global_test_opts_t *gopts, uffd_test_args_t __unused *args)
 {
...
+static void uffd_sigbus_wp_test(uffd_global_test_opts_t *gopts, uffd_test_args_t __unused *args)
 {
...
@@ -853,7 +835,7 @@ static void uffd_events_test_common(bool wp)
 	if (pthread_create(&uffd_mon, NULL, uffd_poll_thread, &args))
 		err("uffd_poll_thread create");
...
+	while (!gopts->ready_for_fork)
 	...
 	pid = fork();
@@ -861,39 +843,39 @@ static void uffd_events_test_common(bool wp)
 		err("fork");
...
+static void uffd_events_test(uffd_global_test_opts_t *gopts, uffd_test_args_t __unused *args)
 {
...
+static void uffd_events_wp_test(uffd_global_test_opts_t *gopts, uffd_test_args_t __unused *args)
 {
...
@@ -903,16 +885,16 @@ static void retry_uffdio_zeropage(int ufd,
 	}
 }
...
@@ -950,25 +932,29 @@ uffd_register_detect_zeropage(int uffd, void *addr, uint64_t len)
 }
 
 /* exercise UFFDIO_ZEROPAGE */
-static void uffd_zeropage_test(uffd_test_args_t __unused *args)
+static void uffd_zeropage_test(uffd_global_test_opts_t *gopts, uffd_test_args_t __unused *args)
 {
 	bool has_zeropage;
 	int i;
...
+						     gopts->page_size))
 	...
 	uffd_test_pass();
@@ -987,26 +973,27 @@ static void uffd_register_poison(int uffd, void *addr, uint64_t len)
...
+				     struct uffd_msg *msg,
+				     struct uffd_args __unused *args)
 {
 	unsigned long offset;
 
@@ -1017,20 +1004,20 @@ static void uffd_poison_handle_fault(
...
+static void uffd_poison_test(uffd_global_test_opts_t *gopts, uffd_test_args_t __unused *targs)
 {
 	pthread_t uffd_mon;
 	char c;
@@ -1039,15 +1026,17 @@ static void uffd_poison_test(uffd_test_args_t __unused *targs)
...
+	memset(gopts->area_src, 0, poison_pages * gopts->page_size);
 	...
 	if (pthread_create(&uffd_mon, NULL, uffd_poll_thread, &args))
@@ -1060,8 +1049,8 @@ static void uffd_poison_test(uffd_test_args_t __unused *targs)
 		err("sigaction");
...
@@ -1074,14 +1063,14 @@ static void uffd_poison_test(uffd_test_args_t __unused *targs)
 			continue;
 		}
...
+	if (write(gopts->pipefd[1], &c, sizeof(c)) != sizeof(c))
 	...
 	if (pthread_join(uffd_mon, NULL))
 		err("pthread_join()");
@@ -1094,7 +1083,9 @@ static void uffd_poison_test(uffd_test_args_t __unused *targs)
 }
...
+			      struct uffd_args *args,
 ...
 {
 	unsigned long offset;
@@ -1106,28 +1097,32 @@ uffd_move_handle_fault_common(struct uffd_msg *msg, struct uffd_args *args,
...
+		      uffd_test_args_t __unused *targs,
...
+)
 {
 	unsigned long nr;
 	pthread_t uffd_mon;
@@ -1139,11 +1134,13 @@ uffd_move_test_common(uffd_test_args_t __unused *targs, unsigned long chunk_size
...
@@ -1151,22 +1148,22 @@ uffd_move_test_common(uffd_test_args_t __unused *targs, unsigned long chunk_size
 	if (pthread_create(&uffd_mon, NULL, uffd_poll_thread, &args))
 		err("uffd_poll_thread create");
...
+		gopts->area_dst = aligned_dst;
 	...
 	/*
@@ -1180,34 +1177,34 @@ uffd_move_test_common(uffd_test_args_t __unused *targs, unsigned long chunk_size
...
+	if (write(gopts->pipefd[1], &c, sizeof(c)) != sizeof(c))
 	...
 	if (pthread_join(uffd_mon, NULL))
 		err("join() failed");
@@ -1218,24 +1215,24 @@ uffd_move_test_common(uffd_test_args_t __unused *targs, unsigned long chunk_size
 		uffd_test_pass();
 }
...
+
 ...
 {
 	usleep(1000);
@@ -1337,7 +1339,9 @@ static void thread_state_until(pid_t tid, thread_state state)
...
@@ -1345,21 +1349,22 @@ static void *uffd_mmap_changing_thread(void *opaque)
...
+static void uffd_mmap_changing_test(uffd_global_test_opts_t *gopts,
+				    uffd_test_args_t __unused *targs)
 {
 	/*
 	 * This stores the real PID (which can be different from how tid is
@@ -1368,13 +1373,14 @@ static void uffd_mmap_changing_test(uffd_test_args_t __unused *targs)
 	pid_t pid = 0;
 	pthread_t tid;
 	int ret;
...
@@ -1388,26 +1394,26 @@ static void uffd_mmap_changing_test(uffd_test_args_t __unused *targs)
...
+	uffd_consume_message(gopts);
 	...
 	assert(ret == 0);
@@ -1415,10 +1421,10 @@ static void uffd_mmap_changing_test(uffd_test_args_t __unused *targs)
 	uffd_test_pass();
 }
...
+	if (madvise(gopts->area_src, gopts->nr_pages * gopts->page_size, MADV_NOHUGEPAGE)) {
 		...
 		if (errno != EINVAL) {
 			if (errmsg)
@@ -1429,10 +1435,10 @@ static int prevent_hugepages(const char **errmsg)
 	return 0;
 }
...
@@ -1456,13 +1462,17 @@ struct uffd_test_case_ops uffd_move_test_pmd_case_ops = {
...
+	ret = uffd_register_with_ioctls(gopts->uffd, gopts->area_dst, gopts->page_size,
 	...
 	/*
@@ -1493,18 +1503,18 @@ do_register_ioctls_test(uffd_test_args_t *args, bool miss, bool wp, bool minor)
...
@@ -1742,6 +1752,28 @@ int main(int argc, char *argv[])
 		}
 		for (j = 0; j < n_mems; j++) {
...
@@ -1756,13 +1788,12 @@ int main(int argc, char *argv[])
...
+			   bool hugetlb)
 {
 	...
 	uint64_t features = 0;
@@ -176,21 +180,21 @@ static void test_one_folio(size_t size, bool private, bool swapout, bool hugetlb
 	}
...
@@ -237,9 +241,9 @@ static void test_one_folio(size_t size, bool private, bool swapout, bool hugetlb
 out:
 	if (mem)
 		munmap(mem, size);
-	if (uffd >= 0) {
...
@@ -331,6 +335,7 @@ static const struct testcase testcases[] = {
