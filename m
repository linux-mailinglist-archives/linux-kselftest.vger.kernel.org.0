Return-Path: <linux-kselftest+bounces-25916-lists+linux-kselftest=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kselftest@lfdr.de
Delivered-To: lists+linux-kselftest@lfdr.de
Received: from sy.mirrors.kernel.org (sy.mirrors.kernel.org [IPv6:2604:1380:40f1:3f00::1])
	by mail.lfdr.de (Postfix) with ESMTPS id 7D23EA2A7B6
	for <lists+linux-kselftest@lfdr.de>; Thu,  6 Feb 2025 12:41:48 +0100 (CET)
Received: from smtp.subspace.kernel.org (relay.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-ECDSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sy.mirrors.kernel.org (Postfix) with ESMTPS id CCF447A1E78
	for <lists+linux-kselftest@lfdr.de>; Thu,  6 Feb 2025 11:40:35 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 0F12F22E3F3;
	Thu,  6 Feb 2025 11:40:36 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=kernel.org header.i=@kernel.org header.b="GSREHtJx"
X-Original-To: linux-kselftest@vger.kernel.org
Received: from smtp.kernel.org (aws-us-west-2-korg-mail-1.web.codeaurora.org [10.30.226.201])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id D448B22C321;
	Thu,  6 Feb 2025 11:40:35 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=10.30.226.201
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1738842035; cv=none; b=Vf5N5cl7S6MxBQAfdTDx9aPeY33wKqVQ8I2WEuAi2IakhFBObU83yqEt/vb2DC5/qTcmhWEqGxxb2geC9lqaEDCgVCH+GP4wmxBTfldT0oz4XWAPNOQpOZGm4IyLASNWwHlFBKJ04aXt9mYUSLb3mHWE1LbLo1vi42on0F9OZTU=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1738842035; c=relaxed/simple;
	bh=BNsC3bEhhpEgEjytHP4/YPGyhoBXglbmji5nqcOhkkQ=;
	h=From:Date:Subject:MIME-Version:Content-Type:Message-Id:References:
	 In-Reply-To:To:Cc; b=dDRfqkiaKNb/vWrlwwAINWtF4spw2YlyJOQtkY4FObhWUgbIqYPpoLLgdnkF9fQxG8+CKJ9A6Tu/Li/w+Lj4k/S+q7NTdyVhxQQY/gsZ1dE6RpElPUf3D+zO9lSzzhPk8o4y/r05aqmq8xi0cMvEAj6V+Mw2rQObY0RBt6Is0k8=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dkim=pass (2048-bit key) header.d=kernel.org header.i=@kernel.org header.b=GSREHtJx; arc=none smtp.client-ip=10.30.226.201
Received: by smtp.kernel.org (Postfix) with ESMTPSA id DE00AC4CEE2;
	Thu,  6 Feb 2025 11:40:29 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
	s=k20201202; t=1738842035;
	bh=BNsC3bEhhpEgEjytHP4/YPGyhoBXglbmji5nqcOhkkQ=;
	h=From:Date:Subject:References:In-Reply-To:To:Cc:From;
	b=
From: Mark Brown <broonie@kernel.org>
Date: Thu, 06 Feb 2025 11:38:06 +0000
Subject: [PATCH RFT v14 4/8] fork: Add shadow stack support to clone3()
Precedence: bulk
...
Message-Id: <20250206-clone3-shadow-stack-v14-4-805b53af73b9@kernel.org>
...
X-Developer-Signature: v=1; a=openpgp-sha256; l=16815; i=broonie@kernel.org;
 h=from:subject:message-id; bh=BNsC3bEhhpEgEjytHP4/YPGyhoBXglbmji5nqcOhkkQ=;
 b=
 5liP2qwKPUm3u5MW1tB8j2IXc/JXzI
...
index 1f633a482558b59aac5427963d42b37fce08c8a6..10ee92390ea1702793bef471452352463e464d2d 100644
...
index 6da6769d7254a46d87118ac016ede70d3f56f020..b56188ef5db27b5b5cf9fb4dfafce3746571a598 100644
--- a/arch/x86/kernel/process.c
+++ b/arch/x86/kernel/process.c
@@ -208,7 +208,7 @@ int copy_thread(struct task_struct *p, const struct kernel_clone_args *args)
...
index 735405a9c5f323b16fdac3832320c255649b6e23..17eb698beaa7f0e3ff42887c5e44d848d91d4417 100644
--- a/kernel/fork.c
+++ b/kernel/fork.c
@@ -2136,6 +2136,51 @@ static void rv_task_fork(struct task_struct *p)
...
@@ -2410,6 +2455,9 @@ __latent_entropy struct task_struct *copy_process(
 	if (retval)
...
@@ -2973,7 +3021,9 @@ noinline static int copy_clone_args_from_user(struct kernel_clone_args *kargs,
...
+	BUILD_BUG_ON(sizeof(struct clone_args) != CLONE_ARGS_SIZE_VER3);
 	...
 	if (unlikely(usize > PAGE_SIZE))
 		return -E2BIG;
@@ -3006,16 +3056,17 @@ noinline static int copy_clone_args_from_user(struct kernel_clone_args *kargs,
 		return -EINVAL;
...
+		.shadow_stack_pointer	= args.shadow_stack_pointer,
 	...
 	if (args.set_tid &&
@@ -3056,6 +3107,27 @@ static inline bool clone3_stack_valid(struct kernel_clone_args *kargs)
 	return true;
 }
...
@@ -3078,7 +3150,7 @@ static bool clone3_args_valid(struct kernel_clone_args *kargs)
 	    kargs->exit_signal)
 		return false;
