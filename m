...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id D6F8A731AF3
	for <lists+linux-kselftest@lfdr.de>; Thu, 15 Jun 2023 16:13:22 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1344986AbjFOONS (ORCPT <rfc822;lists+linux-kselftest@lfdr.de>);
        Thu, 15 Jun 2023 10:13:18 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:42174 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1344929AbjFOOM7 (ORCPT
        <rfc822;linux-kselftest@vger.kernel.org>);
        Thu, 15 Jun 2023 10:12:59 -0400
Received: from madras.collabora.co.uk (madras.collabora.co.uk [IPv6:2a00:1098:0:82:1000:25:2eeb:e5ab])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id E317B2960;
        Thu, 15 Jun 2023 07:12:53 -0700 (PDT)
Received: from localhost.localdomain (unknown [119.155.33.163])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange X25519 server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        (Authenticated sender: usama.anjum)
        by madras.collabora.co.uk (Postfix) with ESMTPSA id 5212A6606F73;
        Thu, 15 Jun 2023 15:12:42 +0100 (BST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=collabora.com;
        s=mail; t=1686838372;
        bh=e9ANnXWGPYTj/WpSvMo3QudwY+Znuko64xTdCJPy+NE=;
        h=From:To:Cc:Subject:Date:In-Reply-To:References:From;
        b=
...
Subject: [PATCH v19 5/5] selftests: mm: add pagemap ioctl tests
Date:   Thu, 15 Jun 2023 19:11:44 +0500
Message-Id: <20230615141144.665148-6-usama.anjum@collabora.com>
...
index 000000000000..1c5de0559a6e
--- /dev/null
...
+			 (vec[0].flags | PAGE_IS_WRITTEN) && (vec[0].flags | PAGE_IS_FILE),
