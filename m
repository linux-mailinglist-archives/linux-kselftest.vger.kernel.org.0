...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 77A723EC534
	for <lists+linux-kselftest@lfdr.de>; Sat, 14 Aug 2021 22:58:28 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S233507AbhHNU6y (ORCPT <rfc822;lists+linux-kselftest@lfdr.de>);
        Sat, 14 Aug 2021 16:58:54 -0400
Received: from us-smtp-delivery-124.mimecast.com ([170.10.133.124]:27599 "EHLO
        us-smtp-delivery-124.mimecast.com" rhost-flags-OK-OK-OK-OK)
        by vger.kernel.org with ESMTP id S233422AbhHNU6s (ORCPT
        <rfc822;linux-kselftest@vger.kernel.org>);
        Sat, 14 Aug 2021 16:58:48 -0400
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
        s=mimecast20190719; t=1628974699;
        h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
         to:to:cc:cc:in-reply-to:in-reply-to:references:references;
        bh=lpu5auuJaje8CJMsJfHNRxZ5/pmu8HTHLFzgxecJ2Mw=;
        b=fR4eYIy5EviDuSVg/OUj7NYNbn+zmu3teO0pRd2sg+Xtz9eW6EsF4Ss6K1294zQUgN1seO
        wHfgMXhCdcxG7pqJ2+tcWQoUEfIP4LSOzR65Bu6Elvc1Zulwre5trA2E4WklbNV8vuC3tb
        TC2tLSXFfJ4/e+PeoXL7WabB0LSNCcA=
Received: from mimecast-mx01.redhat.com (mimecast-mx01.redhat.com
 [209.132.183.4]) (Using TLS) by relay.mimecast.com with ESMTP id
 us-mta-518-LS5yhK_kNLWnSOHrM20c7g-1; Sat, 14 Aug 2021 16:58:16 -0400
X-MC-Unique: LS5yhK_kNLWnSOHrM20c7g-1
Received: from smtp.corp.redhat.com (int-mx01.intmail.prod.int.phx2.redhat.com [10.5.11.11])
        (using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
        (No client certificate requested)
        by mimecast-mx01.redhat.com (Postfix) with ESMTPS id A99BF801AC0;
        Sat, 14 Aug 2021 20:58:14 +0000 (UTC)
Received: from llong.com (unknown [10.22.8.26])
        by smtp.corp.redhat.com (Postfix) with ESMTP id AE41B6E0B6;
...
Subject: [PATCH v6 4/6] cgroup/cpuset: Allow non-top parent partition to distribute out all CPUs
Date:   Sat, 14 Aug 2021 16:57:41 -0400
Message-Id: <20210814205743.3039-5-longman@redhat.com>
...
index 0d4a2ed6fb24..02115e5c818a 100644
...
@@ -2244,6 +2275,13 @@ static int cpuset_can_attach(struct cgroup_taskset *tset)
...
+
 	cgroup_taskset_for_each(task, css, tset) {
 		...
 		if (ret)
@@ -3120,7 +3158,8 @@ hotplug_update_tasks(struct cpuset *cs,
...
@@ -3189,22 +3228,25 @@ static void cpuset_hotplug_update_tasks(struct cpuset *cs, struct tmpmasks *tmp)
