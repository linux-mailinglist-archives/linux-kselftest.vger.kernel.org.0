...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 381D4296749
	for <lists+linux-kselftest@lfdr.de>; Fri, 23 Oct 2020 00:27:44 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S372866AbgJVW1c (ORCPT <rfc822;lists+linux-kselftest@lfdr.de>);
        Thu, 22 Oct 2020 18:27:32 -0400
Received: from mga18.intel.com ([134.134.136.126]:52502 "EHLO mga18.intel.com"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S372845AbgJVW11 (ORCPT <rfc822;linux-kselftest@vger.kernel.org>);
        Thu, 22 Oct 2020 18:27:27 -0400
IronPort-SDR: O6SVOmzx4dK412/srDORDr2sFqBgqhEyP364QqKsv3FeH99BZnlSAUXC+zTUuyqcFntU66Lays
 j4MY734TNExg==
X-IronPort-AV: E=McAfee;i="6000,8403,9782"; a="155386969"
X-IronPort-AV: E=Sophos;i="5.77,404,1596524400"; 
   d="scan'208";a="155386969"
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from orsmga002.jf.intel.com ([10.7.209.21])
  by orsmga106.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 22 Oct 2020 15:27:25 -0700
IronPort-SDR: ZX5T2v5NKXE8XXvZ5wMvAmETaUUH5+spB7YPtVSArIw0FiqtD0yg+rOCpl7ZhgHKRGcwKDLVnm
 OSSGLN4gWWKA==
X-IronPort-AV: E=Sophos;i="5.77,404,1596524400"; 
   d="scan'208";a="333101716"
Received: from iweiny-desk2.sc.intel.com (HELO localhost) ([10.3.52.147])
  by orsmga002-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 22 Oct 2020 15:27:25 -0700
...
Subject: [PATCH 09/10] x86/fault: Report the PKRS state on fault
Date:   Thu, 22 Oct 2020 15:27:00 -0700
Message-Id: <20201022222701.887660-10-ira.weiny@intel.com>
...
+		do_kern_addr_fault(regs, error_code, address, irq_state);
 		...
 		/*
@@ -1479,7 +1487,7 @@ DEFINE_IDTENTRY_RAW_ERRORCODE(exc_page_fault)
