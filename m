Return-Path: <linux-kselftest+bounces-12899-lists+linux-kselftest=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kselftest@lfdr.de
Delivered-To: lists+linux-kselftest@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [139.178.88.99])
	by mail.lfdr.de (Postfix) with ESMTPS id 0777B91B3D4
	for <lists+linux-kselftest@lfdr.de>; Fri, 28 Jun 2024 02:35:36 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id B49BB282799
	for <lists+linux-kselftest@lfdr.de>; Fri, 28 Jun 2024 00:35:34 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id EC4ED4CE04;
	Fri, 28 Jun 2024 00:33:24 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=google.com header.i=@google.com header.b="sOuELMH8"
X-Original-To: linux-kselftest@vger.kernel.org
Received: from mail-yb1-f201.google.com (mail-yb1-f201.google.com [209.85.219.201])
	(using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id ABC342771C
	for <linux-kselftest@vger.kernel.org>; Fri, 28 Jun 2024 00:33:15 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=209.85.219.201
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1719534802; cv=none; b=G8+OUY+SAR8ftgrG33gvBCMOaR7OuJ9h6RNBbAg+CuXBw0v9DiH+u9epQvwHWwuGOgDKKuFJgvPe+kbc45p/24h0OQEFjV8CX2UK5TmTbNE+0CS0G1dyKK5UO/bhyMGOE6tR63sg+aAhONTeykbMX515R07aTuDfvdka9Z6FBUQ=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1719534802; c=relaxed/simple;
	bh=WcB5OwtzN6njlJKR3T2FLNitrtzQhavNgLDMAvh5puU=;
	h=Date:In-Reply-To:Mime-Version:References:Message-ID:Subject:From:
	 To:Cc:Content-Type; b=edroLY6GO4roKMgE6pNiSPDIcWSlOhjK6EzSfQZqpYiAXURb8iLRanDoQILt5pKoT2cLRZdmHv4DKcTD/Yaol/pe9RK8WKsdwBSO9wCQFoOc1PXdiPb89DxqZuqoN7tnJYmSUsY5Rk7nStJGdichCQHnfwQ+23qxOEpvBaTXzaM=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=reject dis=none) header.from=google.com; spf=pass smtp.mailfrom=flex--almasrymina.bounces.google.com; dkim=pass (2048-bit key) header.d=google.com header.i=@google.com header.b=sOuELMH8; arc=none smtp.client-ip=209.85.219.201
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=reject dis=none) header.from=google.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=flex--almasrymina.bounces.google.com
Received: by mail-yb1-f201.google.com with SMTP id 3f1490d57ef6-dfa7a8147c3so54868276.3
        for <linux-kselftest@vger.kernel.org>; Thu, 27 Jun 2024 17:33:15 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=google.com; s=20230601; t=1719534793; x=1720139593; darn=vger.kernel.org;
        h=cc:to:from:subject:message-id:references:mime-version:in-reply-to
         :date:from:to:cc:subject:date:message-id:reply-to;
        bh=A2AdPKXATMYNPeVAeTNhW3yMBZ6qwGlri9S/e9+fgnA=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20230601; t=1719534793; x=1720139593;
        h=cc:to:from:subject:message-id:references:mime-version:in-reply-to
         :date:x-gm-message-state:from:to:cc:subject:date:message-id:reply-to;
        bh=A2AdPKXATMYNPeVAeTNhW3yMBZ6qwGlri9S/e9+fgnA=;
        b=
X-Forwarded-Encrypted: i=1; AJvYcCVGhp3Jooh9qx/fHnAYKW0TeuB8spg/ME1ZtrPlJWdYpYUpI/E8XR7q3FW/yJSPugLAssFN55+VfN9tJk5AjO9mAppQAXytn9KkM8N58swY
X-Gm-Message-State: AOJu0Yy3StPianKutFjDolh+NpTBI6oL2ZOkvuqBfO1OiocAc4RvoTnX
	+7hTAnv4T8kqysE5FO5gUTUv+42UbXbqE9qCusH2tvbpNH1ir8XrJR9tlMg+ddJtogArt9I7LeG
	kX6PEKbx7eEqZkmrweakEug==
X-Google-Smtp-Source: AGHT+IHbcrWA0rxTkUp9lnxt9Axijf5hJitjF8LUzxsfq3ykBRZJIItYv7iXyMAocsovi+iG3Bj5h7t6e7AWp9u5CA==
X-Received: from almasrymina.c.googlers.com ([fda3:e722:ac3:cc00:20:ed76:c0a8:4bc5])
 (user=almasrymina job=sendgmr) by 2002:a25:80c8:0:b0:dfa:b328:475d with SMTP
 id 3f1490d57ef6-e0303ff903cmr505949276.12.1719534793363; Thu, 27 Jun 2024
 17:33:13 -0700 (PDT)
Date: Fri, 28 Jun 2024 00:32:46 +0000
...
Message-ID: <20240628003253.1694510-10-almasrymina@google.com>
Subject: [PATCH net-next v15 09/14] net: add support for skbs with unreadable frags
...
index ec2ed92dcad5d..3e64ab06287a8 100644
--- a/net/ipv4/tcp_input.c
+++ b/net/ipv4/tcp_input.c
@@ -5370,6 +5370,9 @@ tcp_collapse(struct sock *sk, struct sk_buff_head *list, struct rb_root *root,
...
@@ -5390,17 +5393,20 @@ tcp_collapse(struct sock *sk, struct sk_buff_head *list, struct rb_root *root,
 			break;
 		}
...
@@ -5442,7 +5448,8 @@ tcp_collapse(struct sock *sk, struct sk_buff_head *list, struct rb_root *root,
 				if (!skb ||
 				    skb == tail ||
