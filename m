Return-Path: <linux-kselftest+bounces-2133-lists+linux-kselftest=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kselftest@lfdr.de
Delivered-To: lists+linux-kselftest@lfdr.de
Received: from ny.mirrors.kernel.org (ny.mirrors.kernel.org [IPv6:2604:1380:45d1:ec00::1])
	by mail.lfdr.de (Postfix) with ESMTPS id BEB65816969
	for <lists+linux-kselftest@lfdr.de>; Mon, 18 Dec 2023 10:10:31 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by ny.mirrors.kernel.org (Postfix) with ESMTPS id E35931C226AB
	for <lists+linux-kselftest@lfdr.de>; Mon, 18 Dec 2023 09:10:30 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 8203811CAA;
	Mon, 18 Dec 2023 09:08:22 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=gmail.com header.i=@gmail.com header.b="hDOIFxWL"
X-Original-To: linux-kselftest@vger.kernel.org
Received: from mail-oo1-f50.google.com (mail-oo1-f50.google.com [209.85.161.50])
	(using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id E19BF125CC;
	Mon, 18 Dec 2023 09:08:18 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=gmail.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=gmail.com
Received: by mail-oo1-f50.google.com with SMTP id 006d021491bc7-58d1b767b2bso1953145eaf.2;
        Mon, 18 Dec 2023 01:08:18 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=20230601; t=1702890498; x=1703495298; darn=vger.kernel.org;
        h=in-reply-to:content-disposition:mime-version:references:message-id
         :subject:cc:to:from:date:from:to:cc:subject:date:message-id:reply-to;
        bh=I7CEnotSdqtYO6wFk1Enw7g+LmZWKcHqIYC1OsQUg58=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20230601; t=1702890498; x=1703495298;
        h=in-reply-to:content-disposition:mime-version:references:message-id
         :subject:cc:to:from:date:x-gm-message-state:from:to:cc:subject:date
         :message-id:reply-to;
        bh=I7CEnotSdqtYO6wFk1Enw7g+LmZWKcHqIYC1OsQUg58=;
        b=
X-Gm-Message-State: AOJu0YyQ7J1bFVVnzjUdOHg+AxonkIGZDL9TtTI2pC1p5L9V54vPRi7m
	8rZrgTioS1WVFcrchtzg75s=
X-Google-Smtp-Source: AGHT+IHAs0ER0XeZSxerIpxjnrMOG4RuDvgwMVdqPTo1988O9AEiSGJkQguEIFpJk8vaF/2AKAs4Mg==
X-Received: by 2002:a05:6358:5912:b0:170:d431:7e3b with SMTP id g18-20020a056358591200b00170d4317e3bmr15469449rwf.8.1702890497581;
        Mon, 18 Dec 2023 01:08:17 -0800 (PST)
Received: from Laptop-X1 ([43.228.180.230])
        by smtp.gmail.com with ESMTPSA id f16-20020a056a001ad000b006cedd530420sm17185442pfv.52.2023.12.18.01.08.13
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Mon, 18 Dec 2023 01:08:16 -0800 (PST)
Date: Mon, 18 Dec 2023 17:08:11 +0800
...
Subject: Re: [PATCH 06/12] selftests/net: Add TCP-AO + TCP-MD5 + no sign
 listen socket tests
Message-ID: <ZYAL-wOFe4TppNbO@Laptop-X1>
References: <20231215-tcp-ao-selftests-v1-0-f6c08180b985@arista.com>
 <20231215-tcp-ao-selftests-v1-6-f6c08180b985@arista.com>
Precedence: bulk
...
In-Reply-To: <20231215-tcp-ao-selftests-v1-6-f6c08180b985@arista.com>

Hi Dmitry,

With 6.7.0-rc3 I always got error

# selftests: net/tcp_ao: unsigned-md5_ipv6
# 1..72
# # 1577[lib/setup.c:243] rand seed 1702890409
# TAP version 13
...
# # Planned tests != run tests (72 != 55)
# # Totals: pass:54 fail:0 xfail:0 xpass:0 skip:0 error:1
...
Thanks
Hangbin
On Fri, Dec 15, 2023 at 02:36:20AM +0000, Dmitry Safonov wrote:
