...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id CCE5B195770
	for <lists+linux-kselftest@lfdr.de>; Fri, 27 Mar 2020 13:46:04 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1727444AbgC0MqE (ORCPT <rfc822;lists+linux-kselftest@lfdr.de>);
        Fri, 27 Mar 2020 08:46:04 -0400
Received: from aserp2120.oracle.com ([141.146.126.78]:54190 "EHLO
        aserp2120.oracle.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1726515AbgC0MqD (ORCPT
        <rfc822;linux-kselftest@vger.kernel.org>);
        Fri, 27 Mar 2020 08:46:03 -0400
Received: from pps.filterd (aserp2120.oracle.com [127.0.0.1])
        by aserp2120.oracle.com (8.16.0.42/8.16.0.42) with SMTP id 02RChQmT017316;
        Fri, 27 Mar 2020 12:45:56 GMT
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=oracle.com; h=from : to : cc :
 subject : date : message-id : in-reply-to : references; s=corp-2020-01-29;
 bh=V1pTMLf8uQJJT0lcb+f2Z5mArAX1k3NaEZbNbNpyozA=;
 b= lg== 
Received: from aserp3020.oracle.com (aserp3020.oracle.com [141.146.126.70])
        by aserp2120.oracle.com with ESMTP id 2ywavmn5py-1
        (version=TLSv1.2 cipher=ECDHE-RSA-AES256-GCM-SHA384 bits=256 verify=OK);
        Fri, 27 Mar 2020 12:45:56 +0000
Received: from pps.filterd (aserp3020.oracle.com [127.0.0.1])
        by aserp3020.oracle.com (8.16.0.42/8.16.0.42) with SMTP id 02RCh4gK177698;
        Fri, 27 Mar 2020 12:45:56 GMT
Received: from aserv0122.oracle.com (aserv0122.oracle.com [141.146.126.236])
        by aserp3020.oracle.com with ESMTP id 30073gm67g-1
        (version=TLSv1.2 cipher=ECDHE-RSA-AES256-GCM-SHA384 bits=256 verify=OK);
        Fri, 27 Mar 2020 12:45:56 +0000
Received: from abhmp0001.oracle.com (abhmp0001.oracle.com [141.146.116.7])
        by aserv0122.oracle.com (8.14.4/8.14.4) with ESMTP id 02RCjtbE000418;
        Fri, 27 Mar 2020 12:45:55 GMT
Received: from localhost.uk.oracle.com (/10.175.186.71)
        by default (Oracle Beehive Gateway v4.0)
        with ESMTP ; Fri, 27 Mar 2020 05:45:53 -0700
...
Subject: [PATCH v3 kunit-next 1/2] kunit: generalize kunit_resource API beyond allocated resources
Date:   Fri, 27 Mar 2020 12:45:21 +0000
Message-Id: <1585313122-26441-2-git-send-email-alan.maguire@oracle.com>
...
@@ -284,6 +288,64 @@ struct kunit_resource *kunit_alloc_and_get_resource(struct kunit *test,
 						    void *context);
...
@@ -295,7 +357,7 @@ struct kunit_resource *kunit_alloc_and_get_resource(struct kunit *test,
...
+ * Note: KUnit needs to allocate memory for a kunit_resource object. You must
  ...
  * resource.
  */
@@ -307,55 +369,90 @@ static inline void *kunit_alloc_resource(struct kunit *test,
 {
 	struct kunit_resource *res;
...
+#include <linux/kref.h>
 ...
 #include "debugfs.h"
@@ -406,90 +407,93 @@ void __kunit_test_suites_exit(struct kunit_suite **suites)
 }
...
+EXPORT_SYMBOL_GPL(kunit_destroy_resource);
 ...
 struct kunit_kmalloc_params {
 	size_t size;
@@ -500,8 +504,8 @@ static int kunit_kmalloc_init(struct kunit_resource *res, void *context)
 {
 	struct kunit_kmalloc_params *params = context;
...
+	if (!res->data)
 	...
 	return 0;
@@ -509,7 +513,7 @@ static int kunit_kmalloc_init(struct kunit_resource *res, void *context)
...
+	kfree(res->data);
 ...
 void *kunit_kmalloc(struct kunit *test, size_t size, gfp_t gfp)
@@ -529,20 +533,25 @@ void *kunit_kmalloc(struct kunit *test, size_t size, gfp_t gfp)
...
@@ -559,13 +568,16 @@ void kunit_cleanup(struct kunit *test)
 			spin_unlock(&test->lock);
 			break;
 		}
