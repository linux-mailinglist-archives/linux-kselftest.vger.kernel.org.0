
        by smtp.gmail.com with ESMTPSA id d2e1a72fcca58-74af56cb5d9sm14398153b3a.123.2025.07.02.08.21.03
...
Subject: [PATCH v6 1/1] selftests/mm/uffd: Refactor non-composite global vars into struct
Date: Wed,  2 Jul 2025 20:50:57 +0530
Message-Id: <20250702152057.4067-1-ujwal.kundur@gmail.com>
...
---
 ...
 tools/testing/selftests/mm/uffd-common.c     | 272 ++++-----
 ...
 5 files changed, 619 insertions(+), 541 deletions(-)

diff --git a/tools/testing/selftests/mm/uffd-common.c b/tools/testing/selftests/mm/uffd-common.c
index a37088a23ffe..b5c33e5e5b3c 100644
...
@@ -255,59 +270,63 @@ int userfaultfd_open(uint64_t *features)
 	return 0;
 }
...
+	int ret = read(gopts->uffd, msg, sizeof(*msg));
 	...
 	if (ret != sizeof(*msg)) {
 		if (ret < 0) {
@@ -433,7 +452,8 @@ int uffd_read_msg(int ufd, struct uffd_msg *msg)
 	return 0;
 }
...
@@ -442,7 +462,7 @@ void uffd_handle_page_fault(struct uffd_msg *msg, struct uffd_args *args)
...
+		wp_range(gopts->uffd, msg->arg.pagefault.address, gopts->page_size, false);
 		...
 		uint8_t *area;
@@ -460,12 +480,12 @@ void uffd_handle_page_fault(struct uffd_msg *msg, struct uffd_args *args)
 		 * (UFFD-registered).
 		 */
...
@@ -493,10 +513,10 @@ void uffd_handle_page_fault(struct uffd_msg *msg, struct uffd_args *args)
...
@@ -504,6 +524,7 @@ void uffd_handle_page_fault(struct uffd_msg *msg, struct uffd_args *args)
...
+	uffd_global_test_opts_t *gopts = args->gopts;
 	...
 	struct uffd_msg msg;
@@ -514,12 +535,12 @@ void *uffd_poll_thread(void *arg)
...
+	gopts->ready_for_fork = true;
 	...
 	for (;;) {
 		ret = poll(pollfd, 2, -1);
@@ -537,30 +558,30 @@ void *uffd_poll_thread(void *arg)
 		}
...
@@ -568,17 +589,18 @@ void *uffd_poll_thread(void *arg)
 	return NULL;
 }
...
+			(int64_t)uffdio_copy->copy);
 		...
 		err("UFFDIO_COPY retry unexpected: %"PRId64,
 		    (int64_t)uffdio_copy->copy);
@@ -597,60 +619,60 @@ static void wake_range(int ufd, unsigned long addr, unsigned long len)
 			addr), exit(1);
 }
...
index 40af7f67c407..1b69e10dc284 100644
...
index c2ba7d46c7b4..c9da7be91b64 100644
