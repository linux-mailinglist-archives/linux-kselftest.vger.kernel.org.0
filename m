...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 33B273534F1
	for <lists+linux-kselftest@lfdr.de>; Sat,  3 Apr 2021 19:43:14 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S236918AbhDCRfU (ORCPT <rfc822;lists+linux-kselftest@lfdr.de>);
        Sat, 3 Apr 2021 13:35:20 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:56104 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S236866AbhDCRfU (ORCPT
        <rfc822;linux-kselftest@vger.kernel.org>);
        Sat, 3 Apr 2021 13:35:20 -0400
Received: from mail-lf1-x130.google.com (mail-lf1-x130.google.com [IPv6:2a00:1450:4864:20::130])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 7E7C9C06178C
        for <linux-kselftest@vger.kernel.org>; Sat,  3 Apr 2021 10:35:16 -0700 (PDT)
Received: by mail-lf1-x130.google.com with SMTP id 12so11583097lfq.13
        for <linux-kselftest@vger.kernel.org>; Sat, 03 Apr 2021 10:35:16 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=google.com; s=20161025;
        h=mime-version:references:in-reply-to:from:date:message-id:subject:to;
        bh=a0pdmMS8n4YguSw5nDVqslvPHTzA9MgJ0mEYM3JQEmI=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=a0pdmMS8n4YguSw5nDVqslvPHTzA9MgJ0mEYM3JQEmI=;
        b=
X-Gm-Message-State: AOAM533joqbJRPoqa3fD0LqMioj9gDDCP7zLnBz92fe1HP/C3+5IxxdD
        IOkNS3isUbz46bLDsKx43XOIGr+w1BCVa0USj9vrjg==
X-Google-Smtp-Source: ABdhPJzXhgPCuEHQ9y1Td2U5gHDDsUrlVdvPnD1jp8Z5yN/GQ7C7LUtKOUUHgkM17NlurkRgsykrzTIljDYI8G6GdAM=
X-Received: by 2002:a05:6512:3ec:: with SMTP id n12mr13138351lfq.536.1617471314565;
 Sat, 03 Apr 2021 10:35:14 -0700 (PDT)
MIME-Version: 1.0
References: <20210402224359.2297157-1-jingzhangos@google.com> <20210402224359.2297157-3-jingzhangos@google.com>
In-Reply-To: <20210402224359.2297157-3-jingzhangos@google.com>
From:   Jing Zhang <jingzhangos@google.com>
Date:   Sat, 3 Apr 2021 12:35:01 -0500
Message-ID: <CAAdAUthhS7S7hMgRmFEfoHVoR=BbLXpyHvG0gPjnzCREgmOwOw@mail.gmail.com>
...
On Fri, Apr 2, 2021 at 5:44 PM Jing Zhang <jingzhangos@google.com> wrote:
>
...
> index cc5b1e2fdbd0..05459adece42 100644
...
> +       .count = sizeof(kvm_vm_stats_desc) / sizeof(struct _kvm_stats_desc),
...
> +       .name_size = KVM_STATS_NAME_LEN,
> +       .count = sizeof(kvm_vcpu_stats_desc) / sizeof(struct _kvm_stats_desc),
> +       .desc_offset = sizeof(struct kvm_stats_header),
> +       .data_offset = sizeof(struct kvm_stats_header) +
...
> index d78820777de1..e30df2c9455e 100644
...
> index d799029f2e55..fc0e6a00741a 100644
...
> index 07fdd7a1254a..0498655c7820 100644
...
> index 14399985b7de..f2d5ec8ae4ed 100644
...
> index 5d5d4806e93b..b27fa69f3d0f 100644
...
> index 53428b01224e..49412c3d181a 100644
...
> +       {                                                                      \
> +               {type | unit | scale, exponent}, name,                         \
Missing value for "size" field. Should be "{type | unit | scale,
exponent, 1}, name,".
> +       }
