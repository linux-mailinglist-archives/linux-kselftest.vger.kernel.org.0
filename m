...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 0D1B6445042
	for <lists+linux-kselftest@lfdr.de>; Thu,  4 Nov 2021 09:27:47 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S230451AbhKDIaW (ORCPT <rfc822;lists+linux-kselftest@lfdr.de>);
        Thu, 4 Nov 2021 04:30:22 -0400
Received: from mga02.intel.com ([134.134.136.20]:57728 "EHLO mga02.intel.com"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S230410AbhKDIaT (ORCPT <rfc822;linux-kselftest@vger.kernel.org>);
        Thu, 4 Nov 2021 04:30:19 -0400
X-IronPort-AV: E=McAfee;i="6200,9189,10157"; a="218857410"
X-IronPort-AV: E=Sophos;i="5.87,208,1631602800"; 
   d="scan'208";a="218857410"
Received: from orsmga008.jf.intel.com ([10.7.209.65])
  by orsmga101.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 04 Nov 2021 01:27:41 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.87,208,1631602800"; 
   d="scan'208";a="501438411"
Received: from unknown (HELO localhost.igk.intel.com) ([10.102.22.231])
  by orsmga008.jf.intel.com with ESMTP; 04 Nov 2021 01:27:38 -0700
...
Subject: [PATCH net-next 3/6] ice: add support for reading SyncE DPLL state
Date:   Thu,  4 Nov 2021 09:12:28 +0100
Message-Id: <20211104081231.1982753-4-maciej.machnikowski@intel.com>
...
index f099797f35e3..da6cfe19259a 100644
--- a/drivers/net/ethernet/intel/ice/ice_main.c
+++ b/drivers/net/ethernet/intel/ice/ice_main.c
@@ -6240,6 +6240,51 @@ static void ice_napi_disable_all(struct ice_vsi *vsi)
 	}
 }
