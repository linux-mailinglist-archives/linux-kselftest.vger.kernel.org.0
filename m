...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id A2A2E74EF78
	for <lists+linux-kselftest@lfdr.de>; Tue, 11 Jul 2023 14:53:48 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S231208AbjGKMxr (ORCPT <rfc822;lists+linux-kselftest@lfdr.de>);
        Tue, 11 Jul 2023 08:53:47 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:54924 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S232040AbjGKMxf (ORCPT
        <rfc822;linux-kselftest@vger.kernel.org>);
        Tue, 11 Jul 2023 08:53:35 -0400
Received: from madras.collabora.co.uk (madras.collabora.co.uk [46.235.227.172])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 4585E12E;
        Tue, 11 Jul 2023 05:53:32 -0700 (PDT)
Received: from localhost.localdomain (unknown [119.155.40.122])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange X25519 server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        (Authenticated sender: usama.anjum)
        by madras.collabora.co.uk (Postfix) with ESMTPSA id E28B56607010;
        Tue, 11 Jul 2023 13:53:23 +0100 (BST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=collabora.com;
        s=mail; t=1689080011;
        bh=5pZoAXBqrfC7o6fDfQj0GEkzj8IunB1a+vtWUG2GIFg=;
        h=From:To:Cc:Subject:Date:In-Reply-To:References:From;
        b=
...
Subject: [PATCH v24 2/5] fs/proc/task_mmu: Implement IOCTL to get and optionally clear info about PTEs
Date:   Tue, 11 Jul 2023 17:52:38 +0500
Message-Id: <20230711125241.1587820-3-usama.anjum@collabora.com>
...
index cfab855fe7e9..4aadd046e0f8 100644
...
+#include <linux/minmax.h>
 ...
 #include <asm/elf.h>
 #include <asm/tlb.h>
@@ -1768,11 +1769,593 @@ static int pagemap_release(struct inode *inode, struct file *file)
 	return 0;
 }
