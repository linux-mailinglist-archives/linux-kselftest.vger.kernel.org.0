Return-Path: <linux-kselftest+bounces-16644-lists+linux-kselftest=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kselftest@lfdr.de
Delivered-To: lists+linux-kselftest@lfdr.de
Received: from sy.mirrors.kernel.org (sy.mirrors.kernel.org [147.75.48.161])
	by mail.lfdr.de (Postfix) with ESMTPS id 850EC963A64
	for <lists+linux-kselftest@lfdr.de>; Thu, 29 Aug 2024 08:03:13 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sy.mirrors.kernel.org (Postfix) with ESMTPS id EC8C3B22DF2
	for <lists+linux-kselftest@lfdr.de>; Thu, 29 Aug 2024 06:03:10 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 925C416133E;
	Thu, 29 Aug 2024 06:01:46 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=google.com header.i=@google.com header.b="wlKb2Exg"
X-Original-To: linux-kselftest@vger.kernel.org
Received: from mail-yw1-f202.google.com (mail-yw1-f202.google.com [209.85.128.202])
	(using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 4595615853B
	for <linux-kselftest@vger.kernel.org>; Thu, 29 Aug 2024 06:01:40 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=209.85.128.202
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1724911305; cv=none; b=jt6Aq5HXtGqgIo8XD75zJuwfQarL1gYplW/kgFf1HuP2L8+EjokM1X85V2YGA8MmxxUW2OcxuB+DhkfAk5A/yc02TAzInVmQdnTwsh99NoUlIfbn89KRdKU242eamLOUWnapPnVZjwFCieNPt1kKCfGtuxMRVFCcRRugMQhUrw4=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1724911305; c=relaxed/simple;
	bh=ePUjJdfoW1pnMQagYfgjwNuOtUPB1ByH4MzmcCAIFRM=;
	h=Date:In-Reply-To:Mime-Version:References:Message-ID:Subject:From:
	 To:Cc:Content-Type; b=hLpVkFekKzUvvfKtXGzQIqfDAoSsieXQSMrplsQ4IARlR0XAgL+byXHtxzJJL44Re7Xw15IUKKvNCEMU1c9NF9BCvyT6uQ+My0LA4dKjSkFOWxEhm1TqEenKnnJkJy9x6kTokFn+UAshMlCswBHxk+Wqee5fy5TIOBnKXnVUZrg=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=reject dis=none) header.from=google.com; spf=pass smtp.mailfrom=flex--almasrymina.bounces.google.com; dkim=pass (2048-bit key) header.d=google.com header.i=@google.com header.b=wlKb2Exg; arc=none smtp.client-ip=209.85.128.202
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=reject dis=none) header.from=google.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=flex--almasrymina.bounces.google.com
Received: by mail-yw1-f202.google.com with SMTP id 00721157ae682-6b052c5939cso3305457b3.1
        for <linux-kselftest@vger.kernel.org>; Wed, 28 Aug 2024 23:01:40 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=google.com; s=20230601; t=1724911299; x=1725516099; darn=vger.kernel.org;
        h=cc:to:from:subject:message-id:references:mime-version:in-reply-to
         :date:from:to:cc:subject:date:message-id:reply-to;
        bh=yxQ6IUvxabvTNxIBHqvyasMCN6bsqtj1JE9Xe0toDw8=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20230601; t=1724911299; x=1725516099;
        h=cc:to:from:subject:message-id:references:mime-version:in-reply-to
         :date:x-gm-message-state:from:to:cc:subject:date:message-id:reply-to;
        bh=yxQ6IUvxabvTNxIBHqvyasMCN6bsqtj1JE9Xe0toDw8=;
        b=
X-Forwarded-Encrypted: i=1; AJvYcCW8I6rj/COjXBED7KBSPFfF/0pIBK3YPmGQ3eSlr+sOyx7+yTebL8QeO71tNae/J5P/6p8LmjBXXNWRhCgKOVw=@vger.kernel.org
X-Gm-Message-State: AOJu0YzLCNWeciitQfIroYl3QwUhGe/8JyJL+9mcDdAdEQ7+YUcQP8Jn
	IczMxhK8BwEjlqTyS35gqlXB7xIMidA1kKnx5lFzaVQ2I5YO2s67tKfHuVbiKLLKj6V0Z1fQVxE
	YP3JdodsqX2yUwrGpiAG/bg==
X-Google-Smtp-Source: AGHT+IEKV9CeXEZx+57J7IbRNuMyBR4lqtBiNJRBwxCraFSpE42l7Er2Y5IEwdl4JtQrdyndPJKCPzW1tM80u4Fc+w==
X-Received: from almasrymina.c.googlers.com ([fda3:e722:ac3:cc00:20:ed76:c0a8:4bc5])
 (user=almasrymina job=sendgmr) by 2002:a05:690c:3706:b0:68e:8de6:617c with
 SMTP id 00721157ae682-6d285d0b62dmr501657b3.5.1724911299137; Wed, 28 Aug 2024
 23:01:39 -0700 (PDT)
Date: Thu, 29 Aug 2024 06:01:16 +0000
...
Message-ID: <20240829060126.2792671-4-almasrymina@google.com>
Subject: [PATCH net-next v23 03/13] netdev: support binding dma-buf to netdevice
...
---
 ...
 15 files changed, 584 insertions(+), 4 deletions(-)
...
index 63987b8b7c85..dca2fbcb3e2b 100644
--- a/net/core/dev.c
+++ b/net/core/dev.c
...
+
 	...
 	xdp.extack = extack;
@@ -9832,6 +9838,20 @@ int dev_change_xdp_fd(struct net_device *dev, struct netlink_ext_ack *extack,
 	return err;
 }
...
@@ -11368,6 +11388,7 @@ void unregister_netdevice_many_notify(struct list_head *head,
...
index 2d726e65211d..71363d258a52 100644
...
-#include <net/busy_poll.h>
 ...
 #include "netdev-genl-gen.h"
 #include "dev.h"
@@ -721,10 +722,121 @@ int netdev_nl_qstats_get_dumpit(struct sk_buff *skb,
 	return err;
 }
