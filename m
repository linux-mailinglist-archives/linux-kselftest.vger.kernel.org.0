Return-Path: <linux-kselftest+bounces-40766-lists+linux-kselftest=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kselftest@lfdr.de
Delivered-To: lists+linux-kselftest@lfdr.de
Received: from am.mirrors.kernel.org (am.mirrors.kernel.org [IPv6:2604:1380:4601:e00::3])
	by mail.lfdr.de (Postfix) with ESMTPS id 608BFB43824
	for <lists+linux-kselftest@lfdr.de>; Thu,  4 Sep 2025 12:13:08 +0200 (CEST)
Received: from smtp.subspace.kernel.org (relay.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-ECDSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by am.mirrors.kernel.org (Postfix) with ESMTPS id CAD5F1B24F66
	for <lists+linux-kselftest@lfdr.de>; Thu,  4 Sep 2025 10:13:10 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id E57B12FE047;
	Thu,  4 Sep 2025 10:11:27 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=bootlin.com header.i=@bootlin.com header.b="El9Pxk5O"
X-Original-To: linux-kselftest@vger.kernel.org
Received: from smtpout-04.galae.net (smtpout-04.galae.net [185.171.202.116])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 3C69A2C08C4;
	Thu,  4 Sep 2025 10:11:17 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=185.171.202.116
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1756980687; cv=none; b=DC+JixLbcIhJ0hvdsc3pEi8b9TBfdjfXy0+aiXGCLrpXbxw05oEUPKLO0h/g7J686BWCeoUcr6cLYBmBiEamk9/D1cI99G7xT39o1ub4JwwPeUZPtv6KTVvq544N3FnD7Zmkgu8uqDnouKwk39U71En3+v0PRwX2flIFUfN9Ll4=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1756980687; c=relaxed/simple;
	bh=uRQJKp3QuCqJaXA4krsPQYW0RcfFHN/IGcd4TQpY3s0=;
	h=From:Date:Subject:MIME-Version:Content-Type:Message-Id:References:
	 In-Reply-To:To:Cc; b=nvl5np9bFhNS06Siqv0hR/OQ5+ChGz7XgwC12xtY48UM4GdXi6O1EuXjPDaeo1jHcw59BTwtH/UU1AMPkBywU4g+5E8YvZ7DdIkIHiSiQ8kfm07iVb0ePbKPCptZSoybuo7xUAKceL+7jv7/gdlZ5BhP1Qv1s08O0yRCuoROHkI=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=reject dis=none) header.from=bootlin.com; spf=pass smtp.mailfrom=bootlin.com; dkim=pass (2048-bit key) header.d=bootlin.com header.i=@bootlin.com header.b=El9Pxk5O; arc=none smtp.client-ip=185.171.202.116
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=reject dis=none) header.from=bootlin.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=bootlin.com
Received: from smtpout-01.galae.net (smtpout-01.galae.net [212.83.139.233])
	by smtpout-04.galae.net (Postfix) with ESMTPS id 511ADC6B3AC;
	Thu,  4 Sep 2025 10:11:01 +0000 (UTC)
Received: from mail.galae.net (mail.galae.net [212.83.136.155])
	by smtpout-01.galae.net (Postfix) with ESMTPS id 768B6606BB;
	Thu,  4 Sep 2025 10:11:16 +0000 (UTC)
Received: from [127.0.0.1] (localhost [127.0.0.1]) by localhost (Mailerdaemon) with ESMTPSA id 1F8581C22DC71;
	Thu,  4 Sep 2025 12:11:12 +0200 (CEST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=bootlin.com; s=dkim;
	t=1756980674; h=from:subject:date:message-id:to:cc:mime-version:content-type:
	 content-transfer-encoding:in-reply-to:references;
	bh=CwODCGL0outdQgjBlgsMWkCg+D939xL7vc5DuvWero8=;
	b=
From: "Bastien Curutchet (eBPF Foundation)" <bastien.curutchet@bootlin.com>
Date: Thu, 04 Sep 2025 12:10:16 +0200
Subject: [PATCH bpf-next v3 01/14] selftests/bpf: test_xsk: Split
 xskxceiver
Precedence: bulk
...
Message-Id: <20250904-xsk-v3-1-ce382e331485@bootlin.com>
...
---
 ...
 tools/testing/selftests/bpf/test_xsk.c   | 2430 ++++++++++++++++++++++++++++
 tools/testing/selftests/bpf/test_xsk.h   |  297 ++++
 tools/testing/selftests/bpf/xskxceiver.c | 2534 +-----------------------------
 tools/testing/selftests/bpf/xskxceiver.h |  156 --
 5 files changed, 2759 insertions(+), 2660 deletions(-)
...
index 0000000000000000000000000000000000000000..9bcf7b5adbb35bc4f8f74bc24164291c3848d690
--- /dev/null
...
index 352adc8df2d1cd777c823c5a89f1720ee043f342..f4d0071a8f5c5b168d4ac7ac76dc46cb4cdda3cb 100644
...
@@ -446,2327 +250,51 @@ static void parse_command_line(struct ifobject *ifobj_tx, struct ifobject *ifobj
 	}
 }
...
-
 ...
 {
 	u32 i;
@@ -2833,7 +361,7 @@ int main(int argc, char **argv)
...
@@ -2868,7 +396,7 @@ int main(int argc, char **argv)
