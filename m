...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 4ACBD30A318
	for <lists+linux-kselftest@lfdr.de>; Mon,  1 Feb 2021 09:12:46 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S232447AbhBAIM2 (ORCPT <rfc822;lists+linux-kselftest@lfdr.de>);
        Mon, 1 Feb 2021 03:12:28 -0500
Received: from vps-vb.mhejs.net ([37.28.154.113]:42932 "EHLO vps-vb.mhejs.net"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S232032AbhBAIMT (ORCPT <rfc822;linux-kselftest@vger.kernel.org>);
        Mon, 1 Feb 2021 03:12:19 -0500
Received: from MUA
        by vps-vb.mhejs.net with esmtps (TLS1.2:ECDHE-RSA-AES256-GCM-SHA384:256)
        (Exim 4.93.0.4)
        (envelope-from <mail@maciej.szmigiero.name>)
        id 1l6UIf-0004r7-My; Mon, 01 Feb 2021 09:11:09 +0100
...
Subject: [PATCH 2/2] KVM: selftests: add a memslot-related performance benchmark
Date:   Mon,  1 Feb 2021 09:10:57 +0100
Message-Id: <ec67677c725d9f52d4abef3cfef07eac266c15cd.1612139762.git.maciej.szmigiero@oracle.com>
...
index 000000000000..1a632094d2eb
--- /dev/null
...
+	}
+	*slot_runtime = timespec_diff_now(tstart);
+
...
+
+	while (1) {
+		*guest_runtime = timespec_diff_now(tstart);
