Return-Path: <linux-kselftest+bounces-6136-lists+linux-kselftest=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kselftest@lfdr.de
Delivered-To: lists+linux-kselftest@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [139.178.88.99])
	by mail.lfdr.de (Postfix) with ESMTPS id EBAD887716F
	for <lists+linux-kselftest@lfdr.de>; Sat,  9 Mar 2024 14:40:24 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id 9658B2818AA
	for <lists+linux-kselftest@lfdr.de>; Sat,  9 Mar 2024 13:40:23 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 331C83BBF0;
	Sat,  9 Mar 2024 13:40:21 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=alu.unizg.hr header.i=@alu.unizg.hr header.b="teLdZM2y";
	dkim=pass (2048-bit key) header.d=alu.unizg.hr header.i=@alu.unizg.hr header.b="deiS1GKN"
X-Original-To: linux-kselftest@vger.kernel.org
Received: from domac.alu.hr (domac.alu.unizg.hr [161.53.235.3])
	(using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id B89733BBC6;
	Sat,  9 Mar 2024 13:40:15 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=161.53.235.3
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1709991621; cv=none; b=CsvLHyxanSNfWRwbIDiYBzt+VSmYw+e7Vx4hxrEv+mN6gEdT9EdAgs4NWDMtM1DNhfgVBkdJCWInlEno41JUk2tEErsgEZ8zvJRmWYc8Q6QNwuFFZxGnAXcLOyhUB9hJEk0mWOAm25UoT3UJ1aSva4MHnGgLtrvkdUS24CIQYe8=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1709991621; c=relaxed/simple;
	bh=PFC5T6D2tKf5c6ofLV1pGz7uCP6OQZEn6W6sjUZYhMo=;
	h=Content-Type:Message-ID:Date:MIME-Version:To:Cc:From:Subject; b=ryEz85f9/aAv3qxhOmBB1cCd67s6+QSgj1ZoYRco6nr7MSRIVN49N5IftSsKRpONGWgcBckjKtHOGXccWTSjdh+yVepDt0LkhK3gsScnWc3Ao9S25E2T3yngwvL9fZt/nFxn/ijA19F9H1+dNhIA038KB0uCYQYhAE6akZg8HjE=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=alu.unizg.hr; spf=pass smtp.mailfrom=alu.unizg.hr; dkim=pass (2048-bit key) header.d=alu.unizg.hr header.i=@alu.unizg.hr header.b=teLdZM2y; dkim=pass (2048-bit key) header.d=alu.unizg.hr header.i=@alu.unizg.hr header.b=deiS1GKN; arc=none smtp.client-ip=161.53.235.3
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=alu.unizg.hr
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=alu.unizg.hr
Received: from localhost (localhost [127.0.0.1])
	by domac.alu.hr (Postfix) with ESMTP id EDA25601A1;
	Sat,  9 Mar 2024 14:34:09 +0100 (CET)
DKIM-Signature: v=1; a=rsa-sha256; c=simple/simple; d=alu.unizg.hr; s=mail;
	t=1709991249; bh=PFC5T6D2tKf5c6ofLV1pGz7uCP6OQZEn6W6sjUZYhMo=;
	h=Date:To:Cc:From:Subject:From;
	b=
X-Virus-Scanned: Debian amavisd-new at domac.alu.hr
Received: from domac.alu.hr ([127.0.0.1])
	by localhost (domac.alu.hr [127.0.0.1]) (amavisd-new, port 10024)
	with ESMTP id JaYAstbgzRQd; Sat,  9 Mar 2024 14:34:06 +0100 (CET)
Received: from [192.168.178.20] (dh207-40-27.xnet.hr [88.207.40.27])
	by domac.alu.hr (Postfix) with ESMTPSA id 60CC760189;
	Sat,  9 Mar 2024 14:34:06 +0100 (CET)
DKIM-Signature: v=1; a=rsa-sha256; c=simple/simple; d=alu.unizg.hr; s=mail;
	t=1709991246; bh=PFC5T6D2tKf5c6ofLV1pGz7uCP6OQZEn6W6sjUZYhMo=;
	h=Date:To:Cc:From:Subject:From;
	b=
Content-Type: multipart/mixed; boundary="------------5hnIIM4WmMSqAVUxCOwNtFxn"
Message-ID: <e2ba3f8c-80e6-477d-9cea-1c9af820e0ed@alu.unizg.hr>
Date: Sat, 9 Mar 2024 14:34:01 +0100
Precedence: bulk
...
Subject: [BUG net-next selftests/pidfd] Hang in ./pidfd_setns_test
 pidfd_send_signal()

This is a multi-part message in MIME format.
--------------5hnIIM4WmMSqAVUxCOwNtFxn
